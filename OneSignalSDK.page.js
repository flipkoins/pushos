( () => {
    var e = {
        470: function(e, t, i) {
            ...
            n = function() {
                ...
                function t(t) {
                    ...
                    var n, o, s, r = i(/(ipod|iphone|ipad)/i).toLowerCase(), a = !/like android/i.test(t) && /android/i.test(t), l = /nexus\s*[0-6]\s*/i.test(t), d = !l && /nexus\s*[0-9]+/i.test(t), c = /CrOS/.test(t), u = /silk/i.test(t), h = /sailfish/i.test(t), g = /tizen/i.test(t), p = /(web|hpw)os/i.test(t), m = /windows phone/i.test(t), f = (/SamsungBrowser/i.test(t),
                    !m && /windows/i.test(t)), v = !r && !u && /macintosh/i.test(t), b = !a && !h && !g && !p && /linux/i.test(t), S = i(/edge\/(\d+(\.\d+)?)/i), y = i(/version\/(\d+(\.\d+)?)/i), w = /tablet/i.test(t) && !/tablet pc/i.test(t), I = !w && /[^-]mobi/i.test(t), O = /xbox/i.test(t);
                    /opera/i.test(t) ? n = {
                        name: "Opera",
                        opera: e,
                    ...
                    n.webkit = e),
                    !n.version && y && (n.version = y)) : !n.opera && /gecko\//i.test(t) && (n.name = n.name || "Gecko",
                    n.gecko = e,
                    n.version = n.version || i(/gecko\/(\d+(\.\d+)?)/i)),
                    n.windowsphone || n.msedge || !a && !n.silk ? n.windowsphone || n.msedge || !r ? v ? n.mac = e : O ? n.xbox = e : f ? n.windows = e : b && (n.linux = e) : (n[r] = e,
                    n.ios = e) : n.android = e;
                    var E = "";
                    ...
                    }(i(/Windows ((NT|XP)( \d\d?.\d)?)/i)) : n.windowsphone ? E = i(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : n.mac ? E = (E = i(/Mac OS X (\d+([_\.\s]\d+)*)/i)).replace(/[_\s]/g, ".") : r ? E = (E = i(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(/[_\s]/g, ".") : a ? E = i(/android[ \/-](\d+(\.\d+)*)/i) : n.webos ? E = i(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : n.blackberry ? E = i(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : n.bada ? E = i(/bada\/(\d+(\.\d+)*)/i) : n.tizen && (E = i(/tizen[\/\s](\d+(\.\d+)*)/i)),
                    E && (n.osversion = E);
                    var C = !n.windows && E.split(".")[0];
                    return w || d || "ipad" == r || a && (3 == C || C >= 4 && !I) || n.silk ? n.tablet = e : (I || "iphone" == r || "ipod" == r || a || l || n.blackberry || n.webos || n.bada) && (n.mobile = e),
        ...
        365: e => {
            e.exports = function(e, n, o) {
                ...
                n = {});
                n || (n = {});
                var s, r, a = n.prefix || "__jp", l = n.name || a + t++, d = n.param || "callback", c = null != n.timeout ? n.timeout : 6e4, u = encodeURIComponent, h = document.getElementsByTagName("script")[0] || document.head;
        ...
        121: (e, t, i) => {
            ...
            class d {
                ...
                static getBrowser() {
                    return "chrome" === (0,
                    l.M)().name ? n.Chrome : "msedge" === (0,
                    l.M)().name ? n.Edge : "opera" === (0,
                    l.M)().name ? n.Opera : "firefox" === (0,
                    l.M)().name ? n.Firefox : this.isMacOSSafari() ? n.Safari : n.Other
                }
                static isMacOSSafari() {
                    return void 0 !== window.safari
                }
                static getBrowserVersion() {
                    return a.Z.parseVersionString((0,
                    l.M)().version)
                }
            ...
            var c, u, h = i(365), g = i.n(h), p = i(326), m = i(468);
            !function(e) {
            ...
            class y {
                ...
                static getSubscriptionType() {
                    return v.Z.redetectBrowserUserAgent().firefox ? c.FirefoxPush : S.Z.useSafariVapidPush() ? c.SafariPush : S.Z.useSafariLegacyPush() ? c.SafariLegacyPush : c.ChromePush
                }
            ...
            w.ONESIGNAL_ID = "onesignal_id",
            w.EXTERNAL_ID = "external_id";
            var I, O = i(752);
            !function(e) {
            ...
            class x {
                ...
                static call(e, t, i, n) {
                    ...
                    const o = new Headers;
                    if (o.append("Origin", p.Z.getOrigin()),
                ...
                static executeFetch(e, t, i=5) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (0 === i)
                            return Promise.reject(new E(I.RetryLimitReached));
                        try {
                            ...
                            if ("TypeError" === n.name)
                                return yield P(k[i]),
                                C.Z.error(`OneSignal: Network timed out while calling ${e}. Retrying...`),
                                x.executeFetch(e, t, i - 1);
                            throw new O.Z(`OneSignalApiBase: failed to execute HTTP call: ${n}`)
                        }
                    }
                    ))
                }
                static requestHasAppId(e, t) {
                    ...
                    return !(!t || "string" != typeof t.app_id) && (0,
                    T.TP)(t.app_id)
                }
            }
            const N = x;
            ...
            class _ {
                static createUser(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        let s = {};
                        return o && (s = Object.assign(Object.assign({}, s), o)),
                        e.jwtHeader && (s = Object.assign(Object.assign({}, s), e.jwtHeader)),
                ...
                static getUser(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: i} = e;
                        return N.get(`apps/${i}/users/by/${t.label}/${t.id}`, e.jwtHeader)
                    }
                    ))
                }
                static updateUser(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        e.jwtHeader && (r = Object.assign(Object.assign({}, r), e.jwtHeader));
                        const a = A(t.label)
                          , l = A(t.id);
                ...
                static deleteUser(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: i} = e;
                        return N.delete(`apps/${i}/users/by/${t.label}/${t.id}`, e.jwtHeader)
                    }
                    ))
                }
                static addAlias(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: n} = e;
                        return N.patch(`apps/${n}/users/by/${t.label}/${t.id}/identity`, {
                            identity: i
                        }, e.jwtHeader)
                    }
                    ))
                ...
                static getUserIdentity(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: i} = e;
                        return N.get(`apps/${i}/users/by/${t.label}/${t.id}/identity`, e.jwtHeader)
                    }
                    ))
                }
                static deleteAlias(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: n} = e;
                        return N.delete(`apps/${n}/users/by/${t.label}/${t.id}/identity/${i}`, e.jwtHeader)
                    }
                    ))
                }
                static createSubscription(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: n} = e;
                        return N.post(`apps/${n}/users/by/${t.label}/${t.id}/subscriptions`, i, e.jwtHeader)
                    }
                    ))
                }
                ...
                static identifyUserForSubscription(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: n} = e;
                        return N.patch(`apps/${n}/users/by/subscriptions/${t}/identity`, {
                            identity: i
                        }, e.jwtHeader)
                    }
                    ))
                ...
                static transferSubscription(e, t, i, n) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const {appId: o} = e;
                        return N.patch(`apps/${o}/subscriptions/${t}/owner`, {
                            identity: Object.assign({}, i),
                            retain_previous_owner: n
                        }, e.jwtHeader)
                    }
                    ))
                }
            ...
            const U = class {
                ...
                static getUserIdFromSubscriptionIdentifier(e, t, i) {
                    return a.Z.enforceAppId(e),
                    x.post("players", {
                        app_id: e,
                        device_type: t,
                        identifier: i,
                        notification_types: f.TemporaryWebRecord
                    }).then((e => e && e.id ? e.id : null)).catch((e => (C.Z.debug("Error getting user ID from subscription identifier:", e),
                    null)))
                }
                ...
                static sendSessionDuration(e, t, i, n, s) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        try {
                            ...
                            a.notification_ids && a.notification_ids.length > 0 && (yield Z.sendOutcome(a))
                        } catch (e) {
            ...
            class G {
                ...
                static downloadServerAppConfig(e) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        return p.Z.getWindowEnv() === m.Q.Host ? yield new Promise(( (t, i) => {
                            G.jsonpLib(`${p.Z.getOneSignalApiUrl().toString()}/sync/${e}/web`, ( (e, n) => {
            ...
            const R = 30
              ...
              , W = "We'd like to show you notifications for the latest news and updates."
              , $ = "Allow"
              , j = "Cancel"
              , H = "Try Again"
              , Q = {
            ...
            class J {
                ...
                static getCheckedTagCategories(e, t) {
                    ...
                    if (J.isTagObjectEmpty(t)) {
                        const t = (0,
                        T.p$)(e);
                        return J.markAllTagsAsSpecified(t, !0),
                        t
                    }
                    return (0,
                    T.p$)(e).map((e => {
                        const i = t[e.tag];
                        return e.checked = J.getCheckedStatusForTagValue(i),
                        e
                    }
                    ))
                }
            ...
            class X {
                static upgradeConfigToVersionTwo(e) {
                    var t, i, n;
                    X.isPromptOptionsVersion0(e.promptOptions) && (e.promptOptions = X.convertConfigToVersionOne(e.promptOptions)),
                    X.isSlidedownConfigVersion1(null === (t = e.promptOptions) || void 0 === t ? void 0 : t.slidedown) && (null === (i = e.promptOptions) || void 0 === i ? void 0 : i.slidedown) && (e.promptOptions.slidedown = X.convertConfigToVersionTwo(null === (n = e.promptOptions) || void 0 === n ? void 0 : n.slidedown))
                }
                ...
                static convertConfigToVersionTwo(e) {
                    var t, i, n, o;
                    const s = Y.isCategorySlidedownConfiguredVersion1(e) ? B.Category : B.Push;
                    let r, a;
                    s === B.Category && (r = null === (t = e.categories) || void 0 === t ? void 0 : t.positiveUpdateButton,
            ...
            class oe {
                static getAppConfig(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        try {
                            ...
                            return this.checkUnsupportedSubdomain(n),
                ...
                static getIntegrationCapabilities(e) {
                    ...
                    case ee.WordPress:
                        return {
                            configuration: ne.JavaScript
                        };
                    default:
                        return {
                            configuration: ne.Dashboard
                        }
                    }
                }
                static getMergedConfig(e, t) {
                    ...
                    return {
                        ...
                        userConfig: o,
                        enableOnSession: a.Z.valueOrDefault(t.features.enable_on_session, L),
                        sessionThreshold: a.Z.valueOrDefault(t.features.session_threshold, R),
                        enableSessionDuration: a.Z.valueOrDefault(t.features.web_on_focus_enabled, F)
                    }
                }
                ...
                static injectDefaultsIntoPromptOptions(e, t, i) {
                    ...
                    const r = t.customlink
                      , l = Object.assign(Object.assign({}, e), {
                        customlink: {
                            ...
                            unsubscribeEnabled: a.Z.getValueOrDefault(s.unsubscribeEnabled, r.unsubscribeEnabled),
                            text: {
                                subscribe: a.Z.getValueOrDefault(s.text ? s.text.subscribe : void 0, r.text.subscribe),
                                unsubscribe: a.Z.getValueOrDefault(s.text ? s.text.unsubscribe : void 0, r.text.unsubscribe),
                                explanation: a.Z.getValueOrDefault(s.text ? s.text.explanation : void 0, r.text.explanation)
                            },
                            color: {
                                button: a.Z.getValueOrDefault(s.color ? s.color.button : void 0, r.color.button),
                                text: a.Z.getValueOrDefault(s.color ? s.color.text : void 0, r.color.text)
                            }
                        }
                    });
                    return l.slidedown ? l.slidedown.prompts = null === (o = null === (n = l.slidedown) || void 0 === n ? void 0 : n.prompts) || void 0 === o ? void 0 : o.map((e => {
                        var t, i, n, o, s, r, l, d, c;
                        if (e.type = a.Z.getValueOrDefault(e.type, B.Push),
                        e.type === B.Category && (e.text = Object.assign(Object.assign({}, e.text), {
                            positiveUpdateButton: a.Z.getValueOrDefault(null === (t = e.text) || void 0 === t ? void 0 : t.positiveUpdateButton, Q.positiveUpdateButton),
                            negativeUpdateButton: a.Z.getValueOrDefault(null === (i = e.text) || void 0 === i ? void 0 : i.negativeUpdateButton, Q.negativeUpdateButton),
                            updateMessage: a.Z.getValueOrDefault(null === (n = e.text) || void 0 === n ? void 0 : n.updateMessage, Q.updateMessage)
                        })),
                        e.text = Object.assign(Object.assign({}, e.text), {
                            actionMessage: a.Z.getValueOrDefault(null === (o = e.text) || void 0 === o ? void 0 : o.actionMessage, W),
                            acceptButton: a.Z.getValueOrDefault(null === (s = e.text) || void 0 === s ? void 0 : s.acceptButton, $),
                            cancelButton: a.Z.getValueOrDefault(null === (r = e.text) || void 0 === r ? void 0 : r.cancelButton, j),
                            confirmMessage: a.Z.getValueOrDefault(null === (l = e.text) || void 0 === l ? void 0 : l.confirmMessage, K)
                        }),
                        e.autoPrompt = a.Z.getValueOrDefault(e.autoPrompt, !0),
                        e.delay = {
                            pageViews: a.Z.getValueOrDefault(null === (d = e.delay) || void 0 === d ? void 0 : d.pageViews, V.pageViews),
                            timeDelay: a.Z.getValueOrDefault(null === (c = e.delay) || void 0 === c ? void 0 : c.timeDelay, V.timeDelay)
                        },
                        e.categories) {
                    ...
                    l.native ? (l.native.enabled = !!l.native.enabled,
                    l.native.autoPrompt = l.native.hasOwnProperty("autoPrompt") ? !!l.native.enabled && !!l.native.autoPrompt : !!l.native.enabled,
                    l.native.pageViews = a.Z.getValueOrDefault(l.native.pageViews, V.pageViews),
                    l.native.timeDelay = a.Z.getValueOrDefault(l.native.timeDelay, V.timeDelay)) : l.native = {
                        enabled: !1,
                        autoPrompt: !1,
                        pageViews: V.pageViews,
                        timeDelay: V.timeDelay
                    },
                    !0 === i.autoRegister && (l.native.enabled = !0,
                    l.native.autoPrompt = !0),
                    l.autoPrompt = l.native.autoPrompt || Y.isSlidedownAutoPromptConfigured(l.slidedown.prompts),
                    l
                }
                static getPromptOptionsForDashboardConfiguration(e) {
                    const t = e.config.staticPrompts
                      , i = t.native ? {
                        ...
                        pageViews: a.Z.getValueOrDefault(t.native.pageViews, V.pageViews),
                        timeDelay: a.Z.getValueOrDefault(t.native.timeDelay, V.timeDelay)
                    } : {
                        enabled: !1,
                        autoPrompt: !1,
                        pageViews: V.pageViews,
            ...
            var re, InvalidArgumentError = i(86);
            class ae {
                static getRegistration(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        try {
                            ...
                            return void C.Z.warn("[Service Worker Status] Error Checking service worker registration", e, t)
                        }
                    }
                    ))
                }
                static getAvailableServiceWorker(e) {
                    ...
                    return t || C.Z.warn("Could not find an available ServiceWorker instance!"),
                    t
                }
            ...
            class de {
                ...
                broadcast(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        for (const n of i)
                            C.Z.debug(`[Worker Messenger] [SW -> Page] Broadcasting '${e.toString()}' to window client ${n.url}.`),
                            n.postMessage({
                                command: e,
                                payload: t
                            })
                ...
                unicast(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (p.Z.getWindowEnv() === m.Q.ServiceWorker) {
                            if (!i)
                                throw new InvalidArgumentError.R("windowClient",InvalidArgumentError.Q.Empty);
                            C.Z.debug(`[Worker Messenger] [SW -> Page] Unicasting '${e.toString()}' to window client ${i.url}.`),
                            i.postMessage({
                                command: e,
                                payload: t
                            })
                        } else
                            C.Z.debug(`[Worker Messenger] [Page -> SW] Unicasting '${e.toString()}' to service worker.`),
                ...
                directPostMessageToSW(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var i;
                        C.Z.debug(`[Worker Messenger] [Page -> SW] Direct command '${e.toString()}' to service worker.`);
                        const n = yield null === (i = this.context) || void 0 === i ? void 0 : i.serviceWorkerManager.getOneSignalRegistration();
                        if (!n)
                            return void C.Z.error("`[Worker Messenger] [Page -> SW] Could not get ServiceWorkerRegistration to postMessage!");
                        const o = ae.getAvailableServiceWorker(n);
                        o ? o.postMessage({
                            command: e,
                            payload: t
                        }) : C.Z.error("`[Worker Messenger] [Page -> SW] Could not get ServiceWorker to postMessage!")
                    }
                    ))
                }
                listen() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (!S.Z.supportsServiceWorkers())
                            return;
                        p.Z.getWindowEnv() === m.Q.ServiceWorker ? (self.addEventListener("message", this.onWorkerMessageReceivedFromPage.bind(this)),
                        C.Z.debug("[Worker Messenger] Service worker is now listening for messages.")) : yield this.listenForPage()
                    }
                    ))
                }
                listenForPage() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        C.Z.debug(`(${location.origin}) [Worker Messenger] Page is now listening for messages.`)
                    }
                    ))
                }
                onWorkerMessageReceivedFromPage(e) {
                    ...
                    const i = this.replies.findListenersForMessage(t.command)
                      , n = []
                      , o = [];
                    C.Z.debug("[Worker Messenger] Service worker received message:", e.data);
                    for (const e of i)
            ...
            class ce {
                ...
                loadSdkStylesheet() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        return yield this.loadIfNew(0, new URL(`${e}/${t}?v=${S.Z.getSdkStylesVersionHash()}`))
                    }
                    ))
                }
                loadFetchPolyfill() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        try {
                            ...
                            return yield new Promise(( (n, o) => {
                                ...
                                i.onerror = o,
                                i.onload = n,
                                null === (s = document.querySelector("head")) || void 0 === s || s.appendChild(i)
                            }
                            )),
                            0
                        } catch (e) {
            ...
            class pe {
                ...
                incrementPageViewCount() {
                    ...
                    C.Z.debug(`Incremented page view count: newCountSingleTab: ${e},\n      newCountAccrossTabs: ${t}.`)
                }
            ...
            class me {
                ...
                getPermissionStatus() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (!OneSignal.context)
                            throw new O.Z("OneSignal.context is undefined. Make sure to call OneSignal.init() before calling getPermissionStatus().");
                ...
                getNotificationPermission(e) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        return S.Z.useSafariLegacyPush() ? me.getLegacySafariNotificationPermission(e) : this.getW3cNotificationPermission()
                    }
                    ))
                }
                static getLegacySafariNotificationPermission(e) {
                    ...
                    throw new InvalidArgumentError.R("safariWebId",InvalidArgumentError.Q.Empty)
                }
            ...
            class fe {
                constructor(e) {
                    if (!e)
                        throw new InvalidArgumentError.R("path",InvalidArgumentError.Q.Empty);
                    this.path = e.trim()
                }
                getQueryString() {
                ...
                const r = new Promise(( (t, r) => {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        try {
                            ...
                            we.error("Failed to execute callback", e),
                            r()
                        }
                    }
                    ))), i),
                    s = () => {
                        we.debug("Cancel called"),
                        self.clearTimeout(n),
                        a || t()
                    }
                }
            ...
            class Ee {
                ...
                beforeOutcomeSend() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if ((0,
                        T.tI)(e, this.outcomeName),
                        !this.config)
                            return C.Z.debug("Outcomes feature not supported by main application yet."),
                            !1;
                        if (!this.outcomeName)
                            return C.Z.error("Outcome name is required"),
                            !1;
                        yield(0,
                        T.JX)();
                        return !!(yield OneSignal.context.subscriptionManager.isPushNotificationsEnabled()) || (C.Z.warn("Reporting outcomes is supported only for subscribed users."),
                        !1)
                    }
                    ))
                }
                getAttributedNotifsByUniqueOutcomeName() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        return (yield ve.ZP.getAll("SentUniqueOutcome")).filter((e => e.outcomeName === this.outcomeName)).reduce(( (e, t) => [...e, ...t.notificationIds || []]), [])
                    }
                    ))
                }
                ...
                send(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        case D.Unattributed:
                            if (this.isUnique) {
                                if (yield this.wasSentDuringSession())
                                    return void C.Z.warn("(Unattributed) unique outcome was already sent during this session");
                        ...
                        default:
                            return void C.Z.warn("You are on a free plan. Please upgrade to use this functionality.")
                        }
                    }
                    ))
                }
                static getAttribution(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (e.indirect && e.indirect.enabled) {
                            ...
                            if (C.Z.debug(`\tFound total of ${n.length} received notifications`),
                            n.length > 0) {
                                ...
                                C.Z.debug(`\tTotal of ${s.length} received notifications are within reporting window.`);
                                const r = o.filter((e => -1 === s.indexOf(e.notificationId))).map((e => e.notificationId));
                                if (r.forEach((e => ve.ZP.remove(ve.H4, e))),
                                C.Z.debug(`\t${r.length} received notifications will be deleted.`),
                                s.length > 0)
                                    return {
                                        type: D.Indirect,
                                        notificationIds: s
            ...
            class Te {
                static getServiceWorkerHref(e, t, i) {
                    return Te.appendServiceWorkerParams('https://push.bookmylivestock.com/OneSignalSDKWorker.js', t, i)
                }
                static appendServiceWorkerParams(e, t, i) {
                    return `${new URL(e,v.Q.getBaseUrl()).href}?${a.Z.encodeHashAsUriComponent({
                        appId: t
                ...
                static upsertSession(e, t, i, n, s, r, a) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!o) {
                            ...
                            return o && (n.notificationId = o.notificationId),
                            yield ve.ZP.upsertSession(n),
                            void (yield Te.sendOnSessionCallIfNotPlayerCreate(e, t, i, r, n))
                        }
                        ...
                        if (Te.timeInSecondsBetweenTimestamps(l, o.lastDeactivatedTimestamp) <= n)
                            return o.status = Pe.$y.Active,
                ...
                static deactivateSession(e, t, i, n, s, r) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const o = yield ve.ZP.getCurrentSession();
                        if (!o)
                            return void we.debug("No active session found. Cannot deactivate.");
                        const a = () => Te.finalizeSession(e, t, i, o, s, r);
                        if (o.status === Pe.$y.Inactive)
                            return Oe(a, n);
                        if (o.status !== Pe.$y.Active)
                            return void we.warn(`Session in invalid state ${o.status}. Cannot deactivate.`);
                        const l = (new Date).getTime()
                          , d = Te.timeInSecondsBetweenTimestamps(l, o.lastActivatedTimestamp);
                        o.lastDeactivatedTimestamp = l,
                        o.accumulatedDuration += d,
                        o.status = Pe.$y.Inactive;
                        const c = Oe(a, n);
                        return yield ve.ZP.upsertSession(o),
                        c
                    }
                    ))
                }
                static sendOnSessionCallIfNotPlayerCreate(e, t, i, n, s) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        n !== Pe.eB.UserCreate && (ve.ZP.upsertSession(s),
                ...
                static finalizeSession(e, t, i, n, s, r) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (we.debug("Finalize session", `started: ${new Date(n.startTimestamp)}`, `duration: ${n.accumulatedDuration}s`),
                        s) {
                            we.debug(`send on_focus reporting session duration -> ${n.accumulatedDuration}s`);
                            const o = yield Ee.getAttribution(r);
                            we.debug("send on_focus with attribution", o),
                            yield U.sendSessionDuration(e, t, i, n.accumulatedDuration, o)
                        }
                        yield Promise.all([ve.ZP.cleanupCurrentSession(), ve.ZP.removeAllNotificationClickedForOutcomes()]),
                        we.debug("Finalize session finished", `started: ${new Date(n.startTimestamp)}`)
                    }
                    ))
                }
            ...
            class ht {
                ...
                initialize() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e, t;
                        if (!(null === (e = this.config) || void 0 === e ? void 0 : e.enabled))
                            return;
                        if (!(yield this.loadSdkStyles()))
                            return;
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (null === (t = this.config) || void 0 === t ? void 0 : t.text) {
                            if (this.config.text.explanation) {
                                ...
                                T.bF)(t, at),
                                this.config.size && (0,
                                T.bF)(t, this.config.size),
                                (yield OneSignal.context.subscriptionManager.isPushNotificationsEnabled()) ? (0,
                                T.bF)(t, ct.subscribed) : (0,
                                T.bF)(t, ct.unsubscribed),
                                e.appendChild(t)
                            }
                        } else
                            C.Z.error("CustomLink: required property 'text' is missing in the config")
                    }
                    ))
                }
                ...
                loadSdkStyles() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        return 0 === (yield OneSignal.context.dynamicResourceLoader.loadSdkStylesheet()) || (C.Z.debug("Not initializing custom link button because styles failed to load."),
                        !1)
                    }
                    ))
                }
                ...
                handleClick(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!OneSignal.User.PushSubscription.optedIn)
                            return yield OneSignal.User.PushSubscription.optIn(),
                            void ((null === (t = this.config) || void 0 === t ? void 0 : t.unsubscribeEnabled) || this.hideCustomLinkContainers());
                ...
                setTextFromPushStatus(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var t, i, n, o;
                        (null === (i = null === (t = this.config) || void 0 === t ? void 0 : t.text) || void 0 === i ? void 0 : i.subscribe) && ((yield OneSignal.context.subscriptionManager.isPushNotificationsEnabled()) || (e.textContent = this.config.text.subscribe)),
                        (null === (o = null === (n = this.config) || void 0 === n ? void 0 : n.text) || void 0 === o ? void 0 : o.unsubscribe) && (yield OneSignal.context.subscriptionManager.isPushNotificationsEnabled()) && (e.textContent = this.config.text.unsubscribe)
                    }
                    ))
                }
                setCustomColors(e) {
            ...
            class gt {
                static put(e, t) {
                    return void 0 === gt.store[e] && (gt.store[e] = [null, null]),
                    gt.store[e].push(t),
            ...
            function(e) {
                ...
                e[e.PushPermissionAlreadyGranted = 2] = "PushPermissionAlreadyGranted",
            ...
            class InvalidStateError extends O.Z {
                constructor(e, t) {
                    ...
                    case ft.RedundantPermissionMessage:
                        {
                            let e = "";
                            t && t.permissionPromptType && (e = `(${mt[t.permissionPromptType]})`),
            ...
            class wt {
                static showLocalNotification(e, t, i, n, s, r) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("MainHelper:showLocalNotification: ", e, t, i, n, s, r);
                        ...
                        if (!yt.isValidUrl(i))
                            throw new InvalidArgumentError.R("url",InvalidArgumentError.Q.Malformed);
                        if (!yt.isValidUrl(n, {
                            allowEmpty: !0,
                            requireHttps: !0
                        }))
                            throw new InvalidArgumentError.R("icon",InvalidArgumentError.Q.Malformed);
                        if (!n) {
                        ...
                        const a = e => {
                          ...
                          , l = {
                            data: s,
                            launchURL: i,
                            buttons: r ? a(r) : void 0
                        };
                        OneSignal.context.serviceWorkerManager.getRegistration().then((i => (0,
                        o.mG)(this, void 0, void 0, (function*() {
                            if (!i)
                                return void C.Z.error("Service worker registration not available.");
                            const o = {
                                body: t,
                                data: l,
                                icon: n,
                ...
                static checkAndTriggerNotificationPermissionChanged() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const e = yield ve.ZP.get("Options", "notificationPermission")
                          , t = yield OneSignal.context.permissionManager.getPermissionStatus();
                        e !== t && (yield St.Q.triggerNotificationPermissionChanged(),
                ...
                static getNotificationIcons() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        const t = `${p.Z.getOneSignalApiUrl().toString()}/apps/${e}/icon`
                          ...
                          , n = yield i.json();
                        if (n.errors)
                            throw C.Z.error(`API call ${t}`, "failed with:", n.errors),
                ...
                static getSlidedownOptions(e) {
                    return a.Z.getValueOrDefault(e.slidedown, {
                        prompts: []
                    })
                }
                ...
                static getPromptOptionsQueryString() {
                    let e = "";
                    if (wt.getFullscreenPermissionMessageOptions(OneSignal.config.userConfig.promptOptions)) {
                ...
                static getPromptOptionsPostHash() {
                    const e = wt.getFullscreenPermissionMessageOptions(OneSignal.config.userConfig.promptOptions)
                      , t = {};
                    if (e) {
                        const i = {
            ...
            class kt extends Ot {
                constructor(e, t, i) {
                    super(),
                    this.modelName = e,
                    this.modelId = null != i ? i : Math.random().toString(36).substring(2),
                    this.modelName = e,
                    this.data = t,
                ...
                setOneSignalId(e) {
                    ...
                    this.onesignalId = e,
                    e && (null === (t = this.onesignalIdAvailableCallback) || void 0 === t || t.call(this, e))
                }
                setExternalId(e) {
                    (0,
                    T.tI)("setExternalId", {
                ...
                static decode(e) {
                    ...
                    const {modelId: t, modelName: i, onesignalId: n, externalId: s} = e
                      , r = (0,
                    o._T)(e, ["modelId", "modelName", "onesignalId", "externalId"])
                      , a = new kt(i,r,t);
                    return a.setOneSignalId(n),
                    a.setExternalId(s),
                    a
                }
            }
            ...
            function At(e) {
                return null !== e && "object" == typeof e && (null == e ? void 0 : e.constructor) === Object
            }
            function Mt(e) {
            ...
            class _t {
                static initializeUser(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        !t || !i ? (_t.createUserPropertiesModel(),
                        yield _t.createAnonymousUser(e)) : C.Z.debug("User already exists, skipping initialization.")
                    }
                    ))
                }
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (e)
                            ...
                            if (!e)
                                return;
                            t = e.identity,
                            OneSignal.coreDirector.hydrateUser(e)
                        }
                ...
                static createUserPropertiesModel() {
                    ...
                    return OneSignal.coreDirector.add(xt.Q.Properties, t, !1),
                    t
                }
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!t.isCreatingUser) {
                            ...
                            try {
                                ...
                                let o;
                                Dt(null == n ? void 0 : n.data) && (o = null == n ? void 0 : n.data.id);
                                const s = yield _t.getAllUserData()
                                  , r = yield _.createUser({
                                    appId: i,
                                    subscriptionId: o
                                }, s);
                                t.isCreatingUser = !1;
                                ...
                                if (a >= 200 && a < 300) {
                                    ...
                                    n && Dt(n) && OneSignal.coreDirector.getNewRecordsState().add(n.id)
                                }
                                return l
                            } catch (e) {
                                C.Z.error(e)
                ...
                static getAllUserData() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("LoginManager.getAllUserData");
                        const e = OneSignal.coreDirector.getIdentityModel()
                          ...
                          , n = {};
                        return n.identity = null == e ? void 0 : e.data,
                ...
                static copyOneSignalIdPromiseFromIdentityModel() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        t.awaitOneSignalIdAvailable = null == i ? void 0 : i.awaitOneSignalIdAvailable,
                        null === (e = t.awaitOneSignalIdAvailable) || void 0 === e || e.then((e => {
                            t.hasOneSignalId = !0,
                            t.onesignalId = e
                        }
                        ))
            ...
            class Zt {
                constructor() {
                    this.hasOneSignalId = !1,
                    this.isCreatingUser = !1
                }
                static createOrGetInstance() {
                    return Zt.singletonInstance || (Zt.singletonInstance = new Zt,
                    _t.initializeUser(!0).then(( () => {
                ...
                addAlias(e, t) {
                    ...
                    "string" != typeof e)
                        throw new InvalidArgumentError.R("label",InvalidArgumentError.Q.WrongType);
                    if ("string" != typeof t)
                        throw new InvalidArgumentError.R("id",InvalidArgumentError.Q.WrongType);
                    if (!e)
                        throw new InvalidArgumentError.R("label",InvalidArgumentError.Q.Empty);
                    if (!t)
                        throw new InvalidArgumentError.R("id",InvalidArgumentError.Q.Empty);
                    this.addAliases({
                        [e]: t
                    })
                }
                addAliases(e) {
                    ...
                    !e || 0 === Object.keys(e).length)
                        throw new InvalidArgumentError.R("aliases",InvalidArgumentError.Q.Empty);
                    Object.keys(e).forEach((e => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if ("string" != typeof e)
                            throw new InvalidArgumentError.R("label",InvalidArgumentError.Q.WrongType)
                    }
                    ...
                    const t = OneSignal.coreDirector.getIdentityModel();
                    null == t || t.setApplyToRecordId(null == t ? void 0 : t.onesignalId),
                    Object.keys(e).forEach((i => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        null == t || t.set(i, e[i])
                    }
                    ))))
                ...
                addEmail(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        "string" != typeof e)
                            throw new InvalidArgumentError.R("email",InvalidArgumentError.Q.WrongType);
                        if (!e)
                            throw new InvalidArgumentError.R("email",InvalidArgumentError.Q.Empty);
                        if (!(0,
                        T.vV)(e))
                            throw new InvalidArgumentError.R("email",InvalidArgumentError.Q.Malformed);
                        const o = {
                            type: c.Email,
                            token: e
                        }
                          , s = new kt(xt.Q.Subscriptions,o);
                        if ((null === (t = Zt.singletonInstance) || void 0 === t ? void 0 : t.isCreatingUser) || (null === (i = Zt.singletonInstance) || void 0 === i ? void 0 : i.hasOneSignalId)) {
                            s.setOneSignalId(null === (n = Zt.singletonInstance) || void 0 === n ? void 0 : n.onesignalId);
                            const e = OneSignal.coreDirector.getIdentityModel();
                            e.data.external_id && s.setExternalId(e.data.external_id),
                            OneSignal.coreDirector.add(xt.Q.Subscriptions, s, !0)
                        } else
                            OneSignal.coreDirector.add(xt.Q.Subscriptions, s, !1),
                            yield _t.createAndHydrateUser();
                ...
                addSms(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        "string" != typeof e)
                            throw new InvalidArgumentError.R("sms",InvalidArgumentError.Q.WrongType);
                        if (!e)
                            throw new InvalidArgumentError.R("sms",InvalidArgumentError.Q.Empty);
                        const o = {
                            type: c.SMS,
                            token: e
                        }
                ...
                removeEmail(e) {
                    ...
                    Object.keys(t).forEach((i => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        var n;
                        (null === (n = t[i].data) || void 0 === n ? void 0 : n.token) === e && OneSignal.coreDirector.remove(xt.Q.Subscriptions, i)
                    }
                    ))))
                }
                removeSms(e) {
                    ...
                    "string" != typeof e)
                        throw new InvalidArgumentError.R("smsNumber",InvalidArgumentError.Q.WrongType);
                    if (!e)
                        throw new InvalidArgumentError.R("smsNumber",InvalidArgumentError.Q.Empty);
                ...
                addTag(e, t) {
                    ...
                    "string" != typeof e)
                        throw new InvalidArgumentError.R("key",InvalidArgumentError.Q.WrongType);
                    if ("string" != typeof t)
                        throw new InvalidArgumentError.R("value",InvalidArgumentError.Q.WrongType);
                    if (!e)
                        throw new InvalidArgumentError.R("key",InvalidArgumentError.Q.Empty);
                    if (!t)
                        throw new InvalidArgumentError.R("value",InvalidArgumentError.Q.Empty,"Did you mean to call removeTag?");
                    this.addTags({
                        [e]: t
                    })
                }
                addTags(e) {
                    ...
                    "object" != typeof e)
                        throw new InvalidArgumentError.R("tags",InvalidArgumentError.Q.WrongType);
                    if (!e)
                        throw new InvalidArgumentError.R("tags",InvalidArgumentError.Q.Empty);
                    const i = OneSignal.coreDirector.getPropertiesModel();
                    e = Object.assign(Object.assign({}, null === (t = null == i ? void 0 : i.data) || void 0 === t ? void 0 : t.tags), e),
                    null == i || i.set("tags", e)
                }
                removeTag(e) {
                    if ((0,
                    ...
                    "string" != typeof e)
                        throw new InvalidArgumentError.R("tagKey",InvalidArgumentError.Q.WrongType);
                    if (void 0 === e)
                        throw new InvalidArgumentError.R("tagKey",InvalidArgumentError.Q.Empty);
                    this.removeTags([e])
                }
                removeTags(e) {
                    var t;
                    ...
                    !e || 0 === e.length)
                        throw new InvalidArgumentError.R("tagKeys",InvalidArgumentError.Q.Empty);
                    const i = OneSignal.coreDirector.getPropertiesModel()
                    ...
                    null == i || i.setApplyToRecordId(null == i ? void 0 : i.onesignalId),
                    null == i || i.set("tags", n))
                }
                getTags() {
                    var e, t;
                    return (0,
                    T.tI)("getTags"),
                    null === (t = null === (e = OneSignal.coreDirector.getPropertiesModel()) || void 0 === e ? void 0 : e.data) || void 0 === t ? void 0 : t.tags
                }
            }
            ...
            class Gt extends Ut {
                constructor(e, t, i) {
                    super(),
                    e && t ? (this._optedIn = !t.optedOut,
                    this._permission = i,
                    this._token = t.subscriptionToken,
                    OneSignal.coreDirector.getPushSubscriptionModel().then((e => {
                    ...
                    OneSignal.emitter.on(OneSignal.EVENTS.SUBSCRIPTION_CHANGED, (e => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        this._id = null == e ? void 0 : e.current.id,
                        this._token = null == e ? void 0 : e.current.token
                    }
                    )))),
                    OneSignal.emitter.on(OneSignal.EVENTS.NOTIFICATION_PERMISSION_CHANGED_AS_STRING, (e => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        this._permission = e
                    }
                    ))))) : C.Z.warn(`PushSubscriptionNamespace: skipping initialization. One or more required params are falsy: initialize: ${e}, subscription: ${t}`)
                }
                get id() {
                    return this._id
                }
                ...
                _enable(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!yt.isValidBoolean(e))
                            throw new InvalidArgumentError.R("enabled",InvalidArgumentError.Q.Malformed);
                        i.optedOut = !e,
            ...
            var Bt, Rt, Lt, Ft = i(680);
            class Vt extends Ut {
                constructor(e, t, i) {
                    super(),
                    this.PushSubscription = new Gt(!1),
                    e && (this._currentUser = Zt.createOrGetInstance(),
            ...
            class Wt {
                ...
                static checkAndTriggerSubscriptionChanged() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        const t = OneSignal.context
                          , i = yield OneSignal.context.subscriptionManager.isPushNotificationsEnabled()
                          , n = yield OneSignal.context.subscriptionManager.isOptedIn()
                          , o = yield ve.ZP.getAppState()
                          , {lastKnownPushEnabled: s, lastKnownPushId: r, lastKnownPushToken: a, lastKnownOptedIn: l} = o
                          , d = yield wt.getCurrentPushToken()
                          , c = yield OneSignal.coreDirector.getPushSubscriptionModel()
                          , u = null === (e = null == c ? void 0 : c.data) || void 0 === e ? void 0 : e.id;
                ...
                static _onSubscriptionChanged(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var t, i, n;
                        Wt.onSubscriptionChanged_showWelcomeNotification(null === (t = null == e ? void 0 : e.current) || void 0 === t ? void 0 : t.optedIn, null === (i = null == e ? void 0 : e.current) || void 0 === i ? void 0 : i.id),
                        Wt.onSubscriptionChanged_sendCategorySlidedownTags(null === (n = null == e ? void 0 : e.current) || void 0 === n ? void 0 : n.optedIn),
                ...
                static onSubscriptionChanged_sendCategorySlidedownTags(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        Y.isCategorySlidedownConfigured(n) && (yield OneSignal.context.tagManager.sendTags())
                    }
                    ))
                }
                static onSubscriptionChanged_showWelcomeNotification(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (OneSignal.__doNotShowWelcomeNotification)
                            return void C.Z.debug("Not showing welcome notification because user has previously subscribed.");
                        const n = null === (i = OneSignal.config) || void 0 === i ? void 0 : i.userConfig.welcomeNotification;
                        if (void 0 !== n && !0 === n.disable)
                            return;
                        if (!0 !== e)
                            return;
                        if (!t)
                        ...
                        wt.showLocalNotification(o, s, a, void 0, {
                ...
                static onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (e && "function" == typeof e && OneSignal.notifyButton) {
                            !1 !== (yield e()) ? (C.Z.debug("Showing notify button because display predicate returned true."),
                            OneSignal.notifyButton.launcher.show()) : (C.Z.debug("Hiding notify button because display predicate returned false."),
                ...
                static onSubscriptionChanged_updateCustomLink() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        OneSignal.config.userConfig.promptOptions && new ht(OneSignal.config.userConfig.promptOptions.customlink).initialize()
                    }
                    ))
                }
                ...
                static fireStoredNotificationClicks() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        yield(0,
                        T.JX)();
                        const e = OneSignal.config.pageUrl || OneSignal.config.userConfig.pageUrl || document.URL;
                        function t(e) {
                            return (0,
                            o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if ("origin" === (yield ve.ZP.get("Options", "notificationClickHandlerMatch"))) {
                            ...
                            if (n)
                                ...
                                n = i.pendingNotificationClickEvents[o],
                                n && (yield t(n))
                            }
                        }
                    }
                ...
                static checkAndTriggerUserChanged() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        const t = yield ve.ZP.getUserState()
                          ...
                          , r = null === (e = null == o ? void 0 : o.data) || void 0 === e ? void 0 : e.external_id;
                        if (!(s !== i || r !== n))
                            return;
                        ...
                        C.Z.info("User state changed: ", a),
                        Wt.triggerUserChanged(a)
                    }
                    ))
                }
            }
            class $t {
                ...
                static activeSwFileName(e) {
                    ...
                    if ("akam-sw.js" == n) {
                        ...
                        if (e)
                            return C.Z.debug("Found a ServiceWorker under Akamai's akam-sw.js?othersw=", e),
                ...
                swActiveStateByFileName(e) {
                    if (!e)
                        return Ce.None;
                    return e == this.config.workerPath.getFileName() || "OneSignalSDK.sw.js" == e ? Ce.OneSignalWorker : Ce.ThirdParty
                }
                getWorkerVersion() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        o.mG)(this, void 0, void 0, (function*() {
                            ...
                            yield this.context.workerMessenger.unicast(re.WorkerVersion)
                        }
                        ))))
                    }
                    ))
                ...
                shouldInstallWorker() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (C.Z.debug("[shouldInstallWorker] workerState", e),
                        e === Ce.None || e === Ce.ThirdParty) {
                            ...
                            return e && C.Z.info("[shouldInstallWorker] Notification Permissions enabled, will install ServiceWorker"),
                            e
                        }
                ...
                haveParamsChanged() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const e = yield this.getRegistration();
                        if (!e)
                            return C.Z.info("[changedServiceWorkerParams] workerRegistration not found at scope", this.config.registrationOptions.scope),
                            !0;
                        const t = new URL(e.scope).pathname
                          , i = this.config.registrationOptions.scope;
                        if (t != i)
                            return C.Z.info("[changedServiceWorkerParams] ServiceWorker scope changing", {
                                a_old: t,
                                b_new: i
                            }),
                            !0;
                        const n = ae.getAvailableServiceWorker(e)
                          , o = Te.getServiceWorkerHref(this.config, this.context.appConfig.appId, S.Z.version());
                        return !(null == n ? void 0 : n.scriptURL) || o !== n.scriptURL && (C.Z.info("[changedServiceWorkerParams] ServiceWorker href changing:", {
                ...
                workerNeedsUpdate() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        let e;
                        C.Z.info("[Service Worker Update] Checking service worker version...");
                        try {
                            e = yield a.c.timeoutPromise(this.getWorkerVersion(), 2e3)
                        } catch (e) {
                            return C.Z.info("[Service Worker Update] Worker did not reply to version query; assuming older version and updating."),
                            !0
                        }
                        return e !== S.Z.version() ? (C.Z.info(`[Service Worker Update] Updating service worker from ${e} --\x3e ${S.Z.version()}.`),
                        !0) : (C.Z.info(`[Service Worker Update] Service worker version is current at ${e} (no update required).`),
                        !1)
                    }
                    ))
                }
                establishServiceWorkerChannel() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        e.off(),
                        e.on(re.NotificationWillDisplay, (e => (0,
                        o.mG)(this, void 0, void 0, (function*() {
                            C.Z.debug(location.origin, "Received notification display event from service worker.");
                            const t = {
                                notification: e.notification,
                            ...
                            yield be.Z.trigger(OneSignal.EVENTS.NOTIFICATION_WILL_DISPLAY, t)
                        }
                        )))),
                        e.on(re.NotificationClicked, (e => (0,
                        o.mG)(this, void 0, void 0, (function*() {
                            if (0 === OneSignal.emitter.numberOfListeners(OneSignal.EVENTS.NOTIFICATION_CLICKED)) {
                                C.Z.debug("notification.clicked event received, but no event listeners; storing event in IndexedDb for later retrieval.");
                                let t = e.result.url;
                                t || (t = location.href),
                                yield ve.ZP.putNotificationClickedEventPendingUrlOpening(e)
                            } else
                                yield Wt.triggerNotificationClick(e)
                        }
                        )))),
                        e.on(re.NotificationDismissed, (e => (0,
                        o.mG)(this, void 0, void 0, (function*() {
                            yield be.Z.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e)
                        }
                        ))));
                        const t = v.Z.isSafari();
                        e.on(re.AreYouVisible, (i => (0,
                        o.mG)(this, void 0, void 0, (function*() {
                            if (t) {
                                const t = {
                ...
                installWorker() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        (yield this.getActiveState()) === Ce.ThirdParty && C.Z.info("[Service Worker Installation] 3rd party service worker detected.");
                        const e = Te.getServiceWorkerHref(this.config, this.context.appConfig.appId, S.Z.version())
                          , t = `${v.Z.getBaseUrl()}${this.config.registrationOptions.scope}`;
                        let i;
                        C.Z.info(`[Service Worker Installation] Installing service worker ${e} ${t}.`);
                        try {
                            i = yield navigator.serviceWorker.register(e, {
                                scope: t
                            })
                        } catch (e) {
                            C.Z.error(`[Service Worker Installation] Installing service worker failed ${e}`),
                            i = yield this.fallbackToUserModelBetaWorker()
                        }
                        return C.Z.debug("[Service Worker Installation] Service worker installed. Waiting for activation"),
                        yield ae.waitUntilActive(i),
                        C.Z.debug("[Service Worker Installation] Service worker active"),
                ...
                fallbackToUserModelBetaWorker() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const e = "OneSignalSDK.sw.js"
                          ...
                          , i = Te.getServiceWorkerHref(t, this.context.appConfig.appId, S.Z.version())
                          , n = `${v.Z.getBaseUrl()}${this.config.registrationOptions.scope}`;
                        C.Z.info(`[Service Worker Installation] Attempting to install v16 Beta Worker ${i} ${n}.`);
                        try {
            ...
            class qt {
                ...
                subscribe(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        case m.Q.ServiceWorker:
                            ...
                            break;
                        case m.Q.Host:
                            if ((yield OneSignal.context.permissionManager.getPermissionStatus()) === Bt.Denied)
                                throw new PushPermissionNotGrantedError(Rt.Blocked);
                            if (S.Z.useSafariLegacyPush()) {
                                t = yield this.subscribeSafari(),
                                yield this._updatePushSubscriptionModelWithRawSubscription(t),
                                ...
                                t = yield this.subscribeFcmFromPage(e),
                                yield this._updatePushSubscriptionModelWithRawSubscription(t);
                            break;
                        default:
                ...
                _updatePushSubscriptionModelWithRawSubscription(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!t)
                            return OneSignal.coreDirector.generatePushSubscriptionModel(e),
                ...
                getNotificationTypes() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (e)
                            return f.UserOptedOut;
                        return "granted" === (yield OneSignal.context.permissionManager.getPermissionStatus()) ? f.Subscribed : f.NoNativePermission
                    }
                    ))
                }
                updatePushSubscriptionNotificationTypes(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const t = yield OneSignal.coreDirector.getPushSubscriptionModel();
                        t ? (t.set("notification_types", e),
                        t.set("enabled", e === f.Subscribed)) : C.Z.info("No Push Subscription yet to update notification_types.")
                    }
                    ))
                }
                registerSubscription(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        (yield this.isAlreadyRegisteredWithOneSignal()) ? yield this.context.updateManager.sendPushDeviceRecordUpdate() : this.context.sessionManager.upsertSession(Pe.eB.UserCreate);
                        const t = yield ve.ZP.getSubscription();
                        return t.deviceId = "99999999-9999-9999-9999-999999999999",
                        t.optedOut = !1,
                        e ? S.Z.useSafariLegacyPush() ? t.subscriptionToken = e.safariDeviceToken : t.subscriptionToken = e.w3cEndpoint ? e.w3cEndpoint.toString() : null : t.subscriptionToken = null,
                        yield ve.ZP.setSubscription(t),
                        p.Z.getWindowEnv() !== m.Q.ServiceWorker && be.Z.trigger(OneSignal.EVENTS.REGISTERED),
                ...
                subscribeSafariPromptPermission() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        return this.safariPermissionPromptFailed ? e(`${p.Z.getOneSignalApiUrl().toString()}/safari`) : e(`${p.Z.getOneSignalApiUrl().toString()}/safari/apps/${this.config.appId}`)
                    }
                    ))
                }
                subscribeSafari() {
                ...
                subscribeFcmFromPage(e) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (p.Z.getWindowEnv() === m.Q.Host && Notification.permission === Bt.Default) {
                            yield be.Z.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED);
                            const e = yield qt.requestPresubscribeNotificationPermission()
                              , t = e === Bt.Default;
                            switch (yield St.Q.triggerNotificationPermissionChanged(t),
                            e) {
                            case Bt.Default:
                                throw C.Z.debug("Exiting subscription and not registering worker because the permission was dismissed."),
                                OneSignal._sessionInitAlreadyRunning = !1,
                                new PushPermissionNotGrantedError(Rt.Dismissed);
                            case Bt.Denied:
                                throw C.Z.debug("Exiting subscription and not registering worker because the permission was blocked."),
                                OneSignal._sessionInitAlreadyRunning = !1,
                        ...
                        try {
                            ...
                            throw e instanceof ye && (403 === e.status ? yield this.context.subscriptionManager.registerFailedSubscription(f.ServiceWorkerStatus403, this.context) : 404 === e.status && (yield this.context.subscriptionManager.registerFailedSubscription(f.ServiceWorkerStatus404, this.context))),
                            e
                        }
                        if (!t)
                            throw new Error("OneSignal service worker not found!");
                        return C.Z.debug("[Subscription Manager] Service worker is ready to continue subscribing."),
                ...
                getVapidKeyForBrowser() {
                    let e;
                    return e = "firefox" === (0,
                    l.M)().name ? this.config.onesignalVapidPublicKey : this.config.vapidPublicKey,
                    e ? function(e) {
                ...
                subscribeWithVapidKey(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        case 0:
                            if (!i)
                                break;
                            i.options ? C.Z.debug("[Subscription Manager] An existing push subscription exists and it's options is not null.") : (C.Z.debug("[Subscription Manager] An existing push subscription exists and options is null. Unsubscribing from push first now."),
                            yield qt.doPushUnsubscribe(i));
                            break;
                        case 1:
                            i && (yield qt.doPushUnsubscribe(i))
                        }
                        const [n,o] = yield qt.doPushSubscribe(e, this.getVapidKeyForBrowser());
                ...
                static doPushUnsubscribe(e) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        C.Z.debug("[Subscription Manager] Unsubscribing existing push subscription.");
                        const t = yield e.unsubscribe();
                        return C.Z.debug(`[Subscription Manager] Unsubscribing existing push subscription result: ${t}`),
                        t
                    }
                    ))
                }
                static doPushSubscribe(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        C.Z.debug("[Subscription Manager] Subscribing to web push with these options:", i);
                        try {
                            const t = yield e.getSubscription();
                            return [yield e.subscribe(i), !t]
                        } catch (t) {
                            if ("InvalidStateError" == t.name) {
                                C.Z.warn("[Subscription Manager] Couldn't re-subscribe due to applicationServerKey changing, unsubscribe and attempting to subscribe with new key.", t);
                                const n = yield e.getSubscription();
                                return n && (yield qt.doPushUnsubscribe(n)),
                ...
                isSubscriptionExpiring() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((yield this.context.serviceWorkerManager.getActiveState()) !== Ce.OneSignalWorker)
                            return !1;
                ...
                getSubscriptionStateFromBrowserContext() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e, t;
                        const {optedOut: i, subscriptionToken: n} = yield ve.ZP.getSubscription()
                          , o = yield OneSignal.coreDirector.getPushSubscriptionModel()
                          , s = Dt(null == o ? void 0 : o.data) && !!(null == o ? void 0 : o.onesignalId);
                        if (S.Z.useSafariLegacyPush()) {
                        ...
                        const r = yield this.context.serviceWorkerManager.getOneSignalRegistration()
                          , a = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId);
                        if (!r)
                            return {
                                subscribed: !1,
                                optedOut: !!i
                ...
                registerFailedSubscription(e, t) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        t.pageViewManager.isFirstPageView() && (t.subscriptionManager.registerSubscription(new Qt, e),
            ...
            const Kt = class {
                static getServiceWorkerManager(e) {
                    ...
                    return t.userConfig && (t.userConfig.path && (i.workerPath = new fe(`${t.userConfig.path}${t.userConfig.serviceWorkerPath}`)),
                    t.userConfig.serviceWorkerParam && (i.registrationOptions = t.userConfig.serviceWorkerParam)),
                    new $t(e,i)
                }
            ...
            class zt {
                ...
                sendPushDeviceRecordUpdate() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e;
                        (null === (e = Zt.singletonInstance) || void 0 === e ? void 0 : e.hasOneSignalId) ? this.onSessionSent || (yield this.sendOnSessionUpdate()) : C.Z.debug("Not sending the update because user is not registered with OneSignal (no onesignal_id)")
                    }
                    ))
                }
                sendOnSessionUpdate() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!(yield this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal()))
                            return void C.Z.debug("Not sending the on session because user is not registered with OneSignal (no device id)");
                        const t = yield OneSignal.coreDirector.getPushSubscriptionModel();
                        if ((null == t ? void 0 : t.data.notification_types) === f.Subscribed || !0 === (null === (e = OneSignal.config) || void 0 === e ? void 0 : e.enableOnSession))
                            try {
                                this.context.sessionManager.upsertSession(Pe.eB.UserNewSession),
                                this.onSessionSent = !0
                            } catch (e) {
                                C.Z.error(`Failed to update user session. Error "${e.message}" ${e.stack}`)
                            }
                    }
                    ))
                }
                sendOutcomeDirect(e, t, i, n) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (o && Dt(null == o ? void 0 : o.data)) {
                            ...
                            return void 0 !== n && (s.weight = n),
                            void (yield Z.sendOutcome(s))
                        }
                        C.Z.warn("Send outcome aborted because pushSubscriptionModel is not available.")
                    }
                    ))
                }
                ...
                sendOutcomeUnattributed(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (n && Dt(null == n ? void 0 : n.data)) {
                            ...
                            return void 0 !== i && (o.weight = i),
                            void (yield Z.sendOutcome(o))
                        }
                        C.Z.warn("Send outcome aborted because pushSubscriptionModel is not available.")
                    }
                    ))
            ...
            class Jt {
                ...
                notifySWToUpsertSession(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        (null === (n = this.context.environmentInfo) || void 0 === n ? void 0 : n.isBrowserAndSupportsServiceWorkers) ? (C.Z.debug("Notify SW to upsert session"),
                        yield this.context.workerMessenger.unicast(re.SessionUpsert, o)) : C.Z.debug("Notify upsert: do nothing")
                    }
                    ))
                }
                notifySWToDeactivateSession(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        (null === (n = this.context.environmentInfo) || void 0 === n ? void 0 : n.isBrowserAndSupportsServiceWorkers) ? (C.Z.debug("Notify SW to deactivate session"),
                        yield this.context.workerMessenger.unicast(re.SessionDeactivate, o)) : C.Z.debug("Notify deactivate: do nothing")
                    }
                    ))
                }
                _getOneSignalAndSubscriptionIds() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!e || !e.onesignalId)
                            throw new O.Z("Abort _getOneSignalAndSubscriptionIds: no identity");
                        if (!t || !Dt(t.data))
                            throw new O.Z("Abort _getOneSignalAndSubscriptionIds: no subscription");
                ...
                handleVisibilityChange() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e;
                        if (null === (e = Zt.singletonInstance) || void 0 === e ? void 0 : e.hasOneSignalId)
                            try {
                                const e = document.visibilityState
                                  , {onesignalId: t, subscriptionId: i} = yield this._getOneSignalAndSubscriptionIds();
                                if ("visible" === e)
                                    return this.setupOnFocusAndOnBlurForSession(),
                                    C.Z.debug("handleVisibilityChange", "visible", `hasFocus: ${document.hasFocus()}`),
                                    void (document.hasFocus() && (yield this.notifySWToUpsertSession(t, i, Pe.eB.VisibilityVisible)));
                                if ("hidden" === e)
                                    return C.Z.debug("handleVisibilityChange", "hidden"),
                                    ...
                                    void (yield this.notifySWToDeactivateSession(t, i, Pe.eB.VisibilityHidden));
                ...
                handleOnBeforeUnload() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (null === (e = Zt.singletonInstance) || void 0 === e ? void 0 : e.hasOneSignalId)
                            try {
                                const {onesignalId: e, subscriptionId: t} = yield this._getOneSignalAndSubscriptionIds()
                                  , i = {
                                    appId: this.context.appConfig.appId,
                                    onesignalId: e,
                                    subscriptionId: t,
                                ...
                                this.context.workerMessenger.directPostMessageToSW(re.SessionDeactivate, i)
                            } catch (e) {
                ...
                handleOnFocus(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var t;
                        if (C.Z.debug("handleOnFocus", e),
                        null === (t = Zt.singletonInstance) || void 0 === t ? void 0 : t.hasOneSignalId)
                            try {
                                if (e.target !== window)
                                    return;
                                const {onesignalId: t, subscriptionId: i} = yield this._getOneSignalAndSubscriptionIds();
                ...
                upsertSession(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var t, i;
                        if (null === (t = Zt.singletonInstance) || void 0 === t ? void 0 : t.hasOneSignalId) {
                            const {onesignalId: t, subscriptionId: i} = yield this._getOneSignalAndSubscriptionIds();
                            yield this.notifySWToUpsertSession(t, i, e)
                        }
                        (null === (i = this.context.environmentInfo) || void 0 === i ? void 0 : i.isBrowserAndSupportsServiceWorkers) ? this.setupSessionEventListeners() : (this.onSessionSent = e === Pe.eB.UserCreate,
                ...
                setupSessionEventListeners() {
                    var e;
                    (null === (e = this.context.environmentInfo) || void 0 === e ? void 0 : e.isBrowserAndSupportsServiceWorkers) ? (this.setupOnFocusAndOnBlurForSession(),
                    ...
                    OneSignal.cache.isBeforeUnloadEventSetup = !0)) : C.Z.debug("Not setting session event listeners. No service worker possible.")
                }
                ...
                sendOnSessionUpdateFromPage() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e, t;
                        if (this.onSessionSent || !this.context.pageViewManager.isFirstPageView())
                            return;
                        const i = OneSignal.coreDirector.getIdentityModel()
                          , n = null === (e = null == i ? void 0 : i.data) || void 0 === e ? void 0 : e.id;
                        if (!n)
                            return void C.Z.debug("Not sending the on session because user is not registered with OneSignal (no onesignal id)");
                        const o = yield OneSignal.coreDirector.getPushSubscriptionModel();
                        if ((null == o ? void 0 : o.data.notification_types) !== f.Subscribed && !0 !== (null === (t = OneSignal.config) || void 0 === t ? void 0 : t.enableOnSession))
                            return;
                        let s;
                        Dt(null == o ? void 0 : o.data) && (s = null == o ? void 0 : o.data.id);
                        try {
            ...
            class Yt {
                ...
                sendTags() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        C.Z.info("Category Slidedown Local Tags:", this.tagsFromTaggingContainer);
                        const e = J.convertTagsBooleansToApi(this.tagsFromTaggingContainer)
                          , t = J.getObjectDifference(e, this.remoteTags);
                        return J.isTagObjectEmpty(t) ? (C.Z.warn("OneSignal: no change detected in Category preferences. Skipping tag update."),
                        t) : yield OneSignal.User.addTags(t)
                    }
                    ))
                }
            ...
            class ei {
                mount(e, t) {
                    ...
                    T.BH)(n, "disabled"),
                    (0,
                    T.tf)(`#${Ae.loadingContainer}`)
                }
                load() {
                    const e = (0,
                    T.gd)(`#${Ae.loadingContainer}`)
                      , t = (0,
                    T.gd)(`#${Ae.allowButton}`)
                      , i = document.createElement("div");
                    (0,
                    T.bF)(e, `${ke.loadingContainer}`),
                    (0,
                    T.bF)(i, Ve),
                    (0,
                    T.bF)(t, "disabled"),
                    (0,
                    T.IM)(e, "beforeend", Xt($e)),
                    i.innerText = He,
                    e.appendChild(i),
                    t.disabled = !0
                }
            ...
            class ai {
                ...
                initializePhoneInputLibrary() {
                    ...
                    e && window.intlTelInput ? this.itiOneSignal = window.intlTelInput(e, {
                        autoPlaceholder: "off",
                        separateDialCode: !0
                    }) : C.Z.error("OneSignal: there was a problem initializing International Telephone Input")
                }
                addSmsInputEventListeners() {
                    ...
                    e.addEventListener("keyup", (t => {
                        var i;
                        this.smsInputFieldIsValid = this.itiOneSignal.isValidNumber() || "" === (null == e ? void 0 : e.value),
                        "Enter" === t.key && (null === (i = document.getElementById(Ae.allowButton)) || void 0 === i || i.click()),
                ...
                addEmailInputEventListeners() {
                    ...
                    e.addEventListener("keyup", (t => {
                        ...
                        this.emailInputFieldIsValid = ai.validateEmailInputWithReturnVal(n),
                        "Enter" === t.key && (null === (i = document.getElementById(Ae.allowButton)) || void 0 === i || i.click()),
                ...
                static showSmsInputError(e) {
                    ...
                    t && i ? e ? (t.classList.remove(Ye),
                    i.classList.add(Ke)) : (t.classList.add(Ye),
                    i.classList.remove(Ke)) : C.Z.error("OneSignal: couldn't find slidedown validation element")
                }
            ...
            class di {
                constructor(e) {
                    ...
                    case B.Category:
                        ...
                        this.errorButton = a.c.getValueOrDefault(this.options.text.positiveUpdateButton, H);
                        break;
                    case B.Sms:
                    case B.Email:
                    case B.SmsAndEmail:
                        this.errorButton = a.c.getValueOrDefault(this.options.text.acceptButton, H)
                    }
                }
                create(e) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (null === this.notificationIcons) {
                            ...
                            this.container.className.includes(ke.container) && (0,
                            T.tf)(`#${Ae.container}`);
                            ...
                            (0,
                            T.bF)(this.container, (0,
                            l.M)().mobile ? ke.slideUp : ke.slideDown),
                ...
                close() {
                    (0,
                    T.bF)(this.container, ke.closeSlidedown),
                    (0,
                    T.IH)(this.dialog, "animationend", ( (e, t) => {
                        e.target !== this.dialog || "slideDownExit" !== e.animationName && "slideUpExit" !== e.animationName || ((0,
                        T.tf)(`#${Ae.container}`),
                        t())
                    }
                    ), !0)
                ...
                setSaveState() {
                    ...
                    (0,
                    T.IM)(this.buttonIndicatorHolder, "beforeend", Xt(je)),
                    (0,
                    T.bF)(this.allowButton, "disabled"),
                    (0,
                    T.bF)(this.allowButton, ke.savingStateButton)
                }
                removeSaveState() {
                    this.allowButton.textContent = this.positiveUpdateButton,
                    (0,
                    T.tf)(`#${ke.buttonIndicatorHolder}`),
                    this.allowButton.disabled = !1,
                    (0,
                    T.BH)(this.allowButton, "disabled"),
                    (0,
                    T.BH)(this.allowButton, ke.savingStateButton)
                }
                setFailureState() {
                    this.allowButton.textContent = null,
                    this.allowButton.insertAdjacentElement("beforeend", this.getTextSpan(this.errorButton)),
                    this.options.type === B.Category && (this.allowButton.insertAdjacentElement("beforeend", this.getIndicatorHolder()),
                    (0,
                    T.IM)(this.buttonIndicatorHolder, "beforeend", function(e="#FFFFFF") {
                    ...
                    (0,
                    T.bF)(this.allowButton, "onesignal-error-state-button")),
                ...
                removeFailureState() {
                    (0,
                    T.tf)("#onesignal-button-indicator-holder"),
                    (0,
                    T.BH)(this.allowButton, "onesignal-error-state-button"),
                    Y.isSlidedownPushDependent(this.options.type) || ai.resetInputErrorStates(this.options.type),
                    this.isShowingFailureState = !1
                }
                getPlatformNotificationIcon() {
                    return (0,
                    T.S6)(this.notificationIcons)
                }
                getIndicatorHolder() {
                    const e = document.createElement("div");
                    return e.id = Ae.buttonIndicatorHolder,
                    (0,
                    T.bF)(e, ke.buttonIndicatorHolder),
                    e
                }
                getTextSpan(e) {
                ...
                get cancelButton() {
                    return (0,
                    T.gd)(`#${Ae.cancelButton}`)
                }
                get buttonIndicatorHolder() {
                    return (0,
                    T.gd)(`#${Ae.buttonIndicatorHolder}`)
                }
                get slidedownFooter() {
                    return (0,
                    T.gd)(`#${Ae.footer}`)
            ...
            class mi {
                static markPromptDismissedWithType(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        let o = 3;
                        2 == n ? o = 7 : n > 2 && (o = 30),
                        C.Z.debug(`(${p.Z.getWindowEnv().toString()}) OneSignal: User dismissed the ${e} notification prompt; reprompt after ${o} days.`),
                        yield ve.ZP.put("Options", {
                            key: t,
                            value: n
                        });
                ...
                static wasPromptOfTypeDismissed(e) {
                    switch (e) {
                    case oi.Push:
                        return "dismissed" === hi.getItem(ri.OneSignalNotificationPrompt);
                    case oi.NonPush:
            ...
            class vi {
                ...
                show() {
                    return this.hidden ? new Promise((e => {
                        ...
                        if (t ? (this.hideClass && (0,
                        T.BH)(t, this.hideClass),
                        this.showClass && (0,
                        T.bF)(t, this.showClass)) : C.Z.error(`(show) could not find animated element with selector ${this.selector}`),
                        0 == this.targetTransitionEvents.length)
                            return e(this);
                        {
                            const t = setTimeout(( () => {
                                C.Z.debug(`Element did not completely show (state: ${this.state}).`)
                            }
                            ), this.transitionCheckTimeout);
                            (0,
                            T.IH)(this.element, "transitionend", ( (i, n) => {
                                if (i.target === this.element && (0,
                                T.r3)(this.targetTransitionEvents, i.propertyName))
                ...
                hide() {
                    return this.shown ? new Promise((e => {
                        this.state = "hiding",
                        be.Z.trigger(vi.EVENTS.HIDING, this);
                        const t = this.element;
                        if (t ? (this.showClass && (0,
                        T.BH)(t, this.showClass),
                        this.hideClass && (0,
                        T.bF)(t, this.hideClass)) : C.Z.error(`(hide) could not find animated element with selector ${this.selector}`),
                        0 == this.targetTransitionEvents.length)
                            return e(this);
                        (0,
                        T.IH)(this.element, "transitionend", ( (t, i) => {
                            const n = setTimeout(( () => {
                                C.Z.debug(`Element did not completely hide (state: ${this.state}).`)
                            }
                            ), this.transitionCheckTimeout);
                            if (t.target === this.element && (0,
                            T.r3)(this.targetTransitionEvents, t.propertyName))
            ...
            class bi extends vi {
                constructor(e, t, i, n, o, s="shown", r="active", a=["opacity", "transform"], l) {
                    super(e, t, i, s, a),
                    this.selector = e,
                    this.showClass = t,
                    this.hideClass = i,
                ...
                activate() {
                    return this.inactive && this.shown ? new Promise((e => {
                        ...
                        const t = this.element;
                        if (t ? (this.inactiveClass && (0,
                        T.BH)(t, this.inactiveClass),
                        this.activeClass && (0,
                        T.bF)(t, this.activeClass)) : C.Z.error("Could not find active animated element"),
                        !this.shown)
                            return C.Z.debug("Ending activate() transition (alternative)."),
                        ...
                        {
                            const t = setTimeout(( () => {
                                C.Z.debug(`Element did not completely activate (state: ${this.state}, activeState: ${this.activeState}).`)
                            }
                            ), this.transitionCheckTimeout);
                            (0,
                            T.IH)(this.element, "transitionend", ( (i, n) => {
                ...
                inactivate() {
                    return this.active ? new Promise((e => {
                        ...
                        const t = this.element;
                        if (t ? (this.activeClass && (0,
                        T.BH)(t, this.activeClass),
                        this.inactiveClass && (0,
                        T.bF)(t, this.inactiveClass)) : C.Z.error("Could not find active animated element"),
                        !this.shown)
                        ...
                        {
                            const t = setTimeout(( () => {
                                C.Z.debug(`Element did not completely inactivate (state: ${this.state}, activeState: ${this.activeState}).`)
                            }
                            ), this.transitionCheckTimeout);
                            (0,
                            T.IH)(this.element, "transitionend", ( (i, n) => {
            ...
            class yi extends vi {
                ...
                display(e, t, i=0) {
                    return C.Z.debug(`Calling display(${e}, ${t}, ${i}).`),
                    (this.shown ? this.hide() : (0,
                    T.Ld)()).then(( () => {
                        this.content = pt.decodeHtmlEntities(t),
                        this.contentType = e
                    }
                    )).then(( () => this.show())).then(( () => (0,
                    T.gw)(i))).then(( () => this.hide())).then(( () => {
                ...
                getTipForState() {
                    return this.bell.state === Ei.STATES.UNSUBSCRIBED ? this.bell.options.text["tip.state.unsubscribed"] : this.bell.state === Ei.STATES.SUBSCRIBED ? this.bell.options.text["tip.state.subscribed"] : this.bell.state === Ei.STATES.BLOCKED ? this.bell.options.text["tip.state.blocked"] : ""
                }
                enqueue(e) {
                    return this.queued.push(pt.decodeHtmlEntities(e)),
                    new Promise((e => {
            ...
            class wi extends bi {
                ...
                onHovering() {
                    (gt.isEmpty(this.events.mouse) || "out" === gt.getLast(this.events.mouse)) && be.Z.trigger(Ei.EVENTS.HOVERING),
                    gt.put(this.events.mouse, "over")
                }
                onHovered() {
                    gt.put(this.events.mouse, "out"),
                    be.Z.trigger(Ei.EVENTS.HOVERED)
                }
                onTap() {
                    this.pulse(),
                    this.activate(),
                ...
                onClick() {
                    if (be.Z.trigger(Ei.EVENTS.BELL_CLICK),
                    be.Z.trigger(Ei.EVENTS.LAUNCHER_CLICK),
                    this.bell.message.shown && this.bell.message.contentType == yi.TYPES.MESSAGE)
                        return;
                    ...
                    OneSignal.emitter.once(OneSignal.EVENTS.SUBSCRIPTION_CHANGED, ( () => {
                        this.bell.message.display(yi.TYPES.MESSAGE, this.bell.options.text["message.action.subscribed"], yi.TIMEOUT).then(( () => {
                            this.bell._ignoreSubscriptionState = !1,
                            this.bell.launcher.inactivate()
                        }
                        ))
                    }
                    ))) : (this.bell.subscribed || this.bell.blocked) && this.bell.launcher.activateIfInactive().then(( () => {
                        this.bell.showDialogProcedure()
                    }
                    )),
                ...
                pulse() {
                    ...
                    T.tf)(".pulse-ring"),
                    this.element && (0,
                    T.IM)(this.element, "beforeend", '<div class="pulse-ring"></div>'),
            ...
            class Ii extends vi {
                ...
                updateBellLauncherDialogBody() {
                    return OneSignal.context.subscriptionManager.isPushNotificationsEnabled().then((e => {
                        this.nestedContentSelector && (0,
                        T.jI)(this.nestedContentSelector);
                        ...
                        this.bell.state === Ei.STATES.SUBSCRIBED && !0 === e || this.bell.state === Ei.STATES.UNSUBSCRIBED && !1 === e) {
                            let e = "";
                            const n = (0,
                            T.S6)(this.notificationIcons);
                            ...
                            let o = "";
                            o = this.bell.state !== Ei.STATES.SUBSCRIBED ? `<button type="button" class="action" id="${this.subscribeButtonSelectorId}">${this.bell.options.text["dialog.main.button.subscribe"]}</button>` : `<button type="button" class="action" id="${this.unsubscribeButtonSelectorId}">${this.bell.options.text["dialog.main.button.unsubscribe"]}</button>`,
                            ...
                            l.M)().name ? (0,
                            l.M)().mobile || (0,
                            l.M)().tablet || (e = "/bell/chrome-unblock.jpg") : "firefox" === (0,
                            l.M)().name ? e = "/bell/firefox-unblock.jpg" : "safari" == (0,
                            l.M)().name ? e = "/bell/safari-unblock.jpg" : "msedge" === (0,
                            l.M)().name && (e = "/bell/edge-unblock.png");
                            let n = "";
                            e && (e = p.Z.getOneSignalStaticResourcesUrl() + e,
                            n = `<a href="${e}" target="_blank"><img src="${e}"></a></div>`),
                            ((0,
                            l.M)().mobile || (0,
                            l.M)().tablet) && "chrome" === (0,
                            l.M)().name && (n = "<ol><li>Access <strong>Settings</strong> by tapping the three menu dots <strong>⋮</strong></li><li>Click <strong>Site settings</strong> under Advanced.</li><li>Click <strong>Notifications</strong>.</li><li>Find and click this entry for this website.</li><li>Click <strong>Notifications</strong> and set it to <strong>Allow</strong>.</li></ol>"),
                        ...
                        this.nestedContentSelector && (0,
                        T.IM)(this.nestedContentSelector, "beforeend", t),
                        ...
                        this.unsubscribeButton && this.unsubscribeButton.addEventListener("click", ( () => be.Z.trigger(Ei.EVENTS.UNSUBSCRIBE_CLICK))),
                        this.bell.setCustomColorsIfSpecified()
                    }
                    ))
                }
            ...
            class Oi extends bi {
                ...
                resize(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if ("small" === e && (0,
                        T.Uj)(this.element, "onesignal-bell-launcher-sm") || "medium" === e && (0,
                        T.Uj)(this.element, "onesignal-bell-launcher-md") || "large" === e && (0,
                        T.Uj)(this.element, "onesignal-bell-launcher-lg"))
                            return Promise.resolve(this);
                        if ((0,
                        T.BH)(this.element, "onesignal-bell-launcher-sm"),
                        (0,
                        T.BH)(this.element, "onesignal-bell-launcher-md"),
                        (0,
                        T.BH)(this.element, "onesignal-bell-launcher-lg"),
                        "small" === e)
                            (0,
                            T.bF)(this.element, "onesignal-bell-launcher-sm");
                        else if ("medium" === e)
                            (0,
                            T.bF)(this.element, "onesignal-bell-launcher-md");
                        else {
                            if ("large" !== e)
                                throw new Error("Invalid OneSignal bell size " + e);
                            (0,
                            T.bF)(this.element, "onesignal-bell-launcher-lg")
                        }
                        return this.shown ? yield new Promise((e => {
                            ...
                            {
                                const t = setTimeout(( () => {
                                    C.Z.debug(`Launcher did not completely resize (state: ${this.state}, activeState: ${this.activeState}).`)
                                }
                                ), this.transitionCheckTimeout);
                                (0,
                                T.IH)(this.element, "transitionend", ( (i, n) => {
            ...
            class Ei {
                ...
                installEventHooks() {
                    sn.emitter.on(Ei.EVENTS.SUBSCRIBE_CLICK, ( () => {
                        ...
                        sn.User.PushSubscription.optIn().then(( () => (this.dialog.subscribeButton.disabled = !1,
                        this.dialog.hide()))).then(( () => this.message.display(yi.TYPES.MESSAGE, this.options.text["message.action.resubscribed"], yi.TIMEOUT))).then(( () => (this._ignoreSubscriptionState = !1,
                        this.launcher.clearIfWasInactive(),
                        this.launcher.inactivate()))).then(( () => this.updateState())).catch((e => {
                            throw e
                        }
                        ))
                    }
                    ...
                    sn.emitter.on(Ei.EVENTS.UNSUBSCRIBE_CLICK, ( () => {
                        ...
                        sn.User.PushSubscription.optOut().then(( () => (this.dialog.unsubscribeButton.disabled = !1,
                        this.dialog.hide()))).then(( () => (this.launcher.clearIfWasInactive(),
                        this.launcher.activate()))).then(( () => this.message.display(yi.TYPES.MESSAGE, this.options.text["message.action.unsubscribed"], yi.TIMEOUT))).then(( () => this.updateState()))
                    }
                    )),
                    sn.emitter.on(Ei.EVENTS.HOVERING, ( () => {
                        this.hovering = !0,
                        this.launcher.activateIfInactive(),
                        this.message.shown || this.dialog.shown ? this.hovering = !1 : this.message.contentType !== yi.TYPES.MESSAGE ? new Promise((e => {
                            ...
                            this.message.content = pt.decodeHtmlEntities(this.message.getTipForState()),
                    ...
                    sn.emitter.on(Ei.EVENTS.HOVERED, ( () => {
                        this.message.contentType !== yi.TYPES.MESSAGE && this.dialog.hidden && (this.hovering && (this.hovering = !1,
                        this.message.waitUntilShown().then(( () => (0,
                        T.gw)(yi.TIMEOUT))).then(( () => this.message.hide())).then(( () => {
                    ...
                    sn.emitter.on(sn.EVENTS.SUBSCRIPTION_CHANGED, (e => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (e.current.optedIn && (this.badge.shown && this.options.prenotify && this.badge.hide(),
                        null === this.dialog.notificationIcons)) {
                            const e = yield wt.getNotificationIcons();
                            this.dialog.notificationIcons = e
                        }
                        const t = yield sn.context.permissionManager.getPermissionStatus();
                        let i;
                        i = e.current.optedIn ? Ei.STATES.SUBSCRIBED : t === Bt.Denied ? Ei.STATES.BLOCKED : Ei.STATES.UNSUBSCRIBED,
                        this.setState(i, this._ignoreSubscriptionState)
                    }
                    )))),
                    sn.emitter.on(Ei.EVENTS.STATE_CHANGED, (e => {
                        this.launcher.element && (e.to === Ei.STATES.SUBSCRIBED ? this.launcher.inactivate() : (e.to === Ei.STATES.UNSUBSCRIBED || Ei.STATES.BLOCKED) && this.launcher.activate())
                    }
                    )),
                    sn.emitter.on(sn.EVENTS.NOTIFICATION_PERMISSION_CHANGED_AS_STRING, ( () => {
                        this.updateState()
                    }
                    ))
                }
                addDefaultClasses() {
                    ...
                    if ("bottom-left" === this.options.position)
                        e && (0,
                        T.bF)(e, "onesignal-bell-container-bottom-left"),
                        (0,
                        T.bF)(this.launcher.selector, "onesignal-bell-launcher-bottom-left");
                    else {
                        if ("bottom-right" !== this.options.position)
                            throw new Error(`Invalid OneSignal notify button position ${this.options.position}`);
                        e && (0,
                        T.bF)(e, "onesignal-bell-container-bottom-right"),
                        (0,
                        T.bF)(this.launcher.selector, "onesignal-bell-launcher-bottom-right")
                    }
                    if ("default" === this.options.theme)
                        (0,
                        T.bF)(this.launcher.selector, "onesignal-bell-launcher-theme-default");
                    else {
                        if ("inverse" !== this.options.theme)
                            throw new Error(`Invalid OneSignal notify button theme ${this.options.theme}`);
                        (0,
                        T.bF)(this.launcher.selector, "onesignal-bell-launcher-theme-inverse")
                    }
                }
                create() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (!this.options.enable)
                            return;
                        if (0 !== (yield sn.context.dynamicResourceLoader.loadSdkStylesheet()))
                            return void C.Z.debug("Not showing notify button because styles failed to load.");
                        this.container && (0,
                        T.tf)("#onesignal-bell-container"),
                        (0,
                        T.IM)("body", "beforeend", '<div id="onesignal-bell-container" class="onesignal-bell-container onesignal-reset"></div>'),
                        this.container && (0,
                        T.IM)(this.container, "beforeend", '<div id="onesignal-bell-launcher" class="onesignal-bell-launcher"></div>'),
                        (0,
                        T.IM)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-button"></div>'),
                        (0,
                        T.IM)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-badge"></div>'),
                        (0,
                        T.IM)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-message"></div>'),
                        (0,
                        T.IM)(this.message.selector, "beforeend", '<div class="onesignal-bell-launcher-message-body"></div>'),
                        (0,
                        T.IM)(this.launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-dialog"></div>'),
                        (0,
                        T.IM)(this.dialog.selector, "beforeend", '<div class="onesignal-bell-launcher-dialog-body"></div>'),
                        (0,
                        T.IM)(this.button.selector, "beforeend", '<svg class="onesignal-bell-svg" xmlns="http://www.w3.org/2000/svg" width="99.7" height="99.7" viewBox="0 0 99.7 99.7"><circle class="background" cx="49.9" cy="49.9" r="49.9"/><path class="foreground" d="M50.1 66.2H27.7s-2-.2-2-2.1c0-1.9 1.7-2 1.7-2s6.7-3.2 6.7-5.5S33 52.7 33 43.3s6-16.6 13.2-16.6c0 0 1-2.4 3.9-2.4 2.8 0 3.8 2.4 3.8 2.4 7.2 0 13.2 7.2 13.2 16.6s-1 11-1 13.3c0 2.3 6.7 5.5 6.7 5.5s1.7.1 1.7 2c0 1.8-2.1 2.1-2.1 2.1H50.1zm-7.2 2.3h14.5s-1 6.3-7.2 6.3-7.3-6.3-7.3-6.3z"/><ellipse class="stroke" cx="49.9" cy="49.9" rx="37.4" ry="36.9"/></svg>');
                        const e = yield sn.context.subscriptionManager.isPushNotificationsEnabled();
                        ...
                        yield(e ? this.launcher.inactivate() : (0,
                        T.Ld)()).then(( () => e && null === this.dialog.notificationIcons ? wt.getNotificationIcons().then((e => {
                            this.dialog.notificationIcons = e
                        }
                        )) : (0,
                        T.Ld)())).then(( () => (0,
                        T.gw)(this.options.showLauncherAfter || 0))).then(( () => this.launcher.show())).then(( () => (0,
                        T.gw)(this.options.showBadgeAfter || 0))).then(( () => this.options.prenotify && !e && sn._isNewVisitor ? this.message.enqueue(this.options.text["message.prenotify"]).then(( () => this.badge.show())) : (0,
                        T.Ld)())).then(( () => this.initialized = !0))
                    }
                    ))
                }
                patchSafariSvgFilterBug() {
                    ...
                    "safari" == (0,
                    l.M)().name && this.badge.element.setAttribute("style", "display: none;")
                }
                applyOffsetIfSpecified() {
                    ...
                    if (e) {
                        ...
                        if (!t)
                            return void C.Z.error("Could not find bell dom element");
                        t.style.cssText = "",
                ...
                updateState() {
                    Promise.all([sn.context.subscriptionManager.isPushNotificationsEnabled(), sn.context.permissionManager.getPermissionStatus()]).then(( ([e,t]) => {
                        this.setState(e ? Ei.STATES.SUBSCRIBED : Ei.STATES.UNSUBSCRIBED),
                ...
                setState(e, t=!1) {
                    const i = this.state;
                    this.state = e,
                    i === e || t || be.Z.trigger(Ei.EVENTS.STATE_CHANGED, {
                        from: i,
                        to: e
                    })
                }
                ...
                get launcher() {
                    return this._launcher || (this._launcher = new Oi(this)),
                    this._launcher
                }
                get button() {
                    return this._button || (this._button = new wi(this)),
                    this._button
                }
                get badge() {
                    return this._badge || (this._badge = new Si),
                    this._badge
                }
                get message() {
                    return this._message || (this._message = new yi(this)),
                    this._message
                }
                get dialog() {
                    return this._dialog || (this._dialog = new Ii(this)),
                    this._dialog
                }
                get subscribed() {
            ...
            class Ci {
                static internalInit() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        "visible" === document.visibilityState ? yield Ci.sessionInit() : Ci.postponeSessionInitUntilPageIsInFocus()
                    }
                    ))
                }
                static postponeSessionInitUntilPageIsInFocus() {
                    (0,
                    T.IH)(document, "visibilitychange", ( (e, t) => {
                ...
                static sessionInit() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (C.Z.debug("Called sessionInit()"),
                        OneSignal._sessionInitAlreadyRunning)
                            return void C.Z.debug("Returning from sessionInit because it has already been called.");
                        OneSignal._sessionInitAlreadyRunning = !0;
                        try {
                            yield Ci.doInitialize()
                        } catch (e) {
                            if (e instanceof SdkInitError)
                                return;
                            throw e
                        }
                        const e = yield OneSignal.context.subscriptionManager.isOptedOut()
                ...
                static storeInitialValues() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        const e = yield OneSignal.context.subscriptionManager.isPushNotificationsEnabled()
                          , t = yield OneSignal.context.permissionManager.getPermissionStatus()
                ...
                static setWelcomeNotificationFlag() {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        (yield OneSignal.context.permissionManager.getNotificationPermission(OneSignal.context.appConfig.safariWebId)) === Bt.Granted && (OneSignal.__doNotShowWelcomeNotification = !0)
                    }
                    ))
                }
                ...
                static processExpiringSubscriptions() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!(yield e.subscriptionManager.isSubscriptionExpiring()))
                            return C.Z.debug("Subscription is not considered expired."),
                            !1;
                        C.Z.debug("Subscription is considered expiring.");
                        const t = yield e.subscriptionManager.subscribe(1);
                        return yield e.subscriptionManager.registerSubscription(t),
                        !0
                    }
                    ))
                }
                ...
                static showNotifyButton() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (S.Z.isBrowser() && !OneSignal.notifyButton) {
                            ...
                            const e = OneSignal.config.userConfig.notifyButton.displayPredicate;
                            e && "function" == typeof e ? OneSignal.emitter.once(OneSignal.EVENTS.SDK_INITIALIZED, ( () => (0,
                            o.mG)(this, void 0, void 0, (function*() {
                                !1 !== (yield Promise.resolve(OneSignal.config.userConfig.notifyButton.displayPredicate())) ? (OneSignal.notifyButton = new Ei(OneSignal.config.userConfig.notifyButton),
                                OneSignal.notifyButton.create()) : C.Z.debug("Notify button display predicate returned false so not showing the notify button.")
                            }
                            )))) : (OneSignal.notifyButton = new Ei(OneSignal.config.userConfig.notifyButton),
                ...
                static showPromptsFromWebConfigEditor() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        e.userConfig.promptOptions && (yield new ht(e.userConfig.promptOptions.customlink).initialize())
                    }
                    ))
                }
                static installNativePromptPermissionChangedHook() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        try {
                            ...
                            C.Z.warn(`Could not install native notification permission change hook w/ error: ${e}`)
                        }
                    }
                    ))
                }
                static saveInitOptions() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        e.push(ve.ZP.put("Options", {
                            key: "persistNotification",
                            value: null == t || t
                        }));
                        const i = OneSignal.config.userConfig.webhooks;
                        return ["notification.willDisplay", "notification.clicked", "notification.dismissed"].forEach((t => {
                            i && i[t] ? e.push(ve.ZP.put("Options", {
                                key: `webhooks.${t}`,
                                value: i[t]
                            })) : e.push(ve.ZP.put("Options", {
                                key: `webhooks.${t}`,
                        ...
                        i && i.cors ? e.push(ve.ZP.put("Options", {
                            key: "webhooks.cors",
                            value: !0
                        })) : e.push(ve.ZP.put("Options", {
                            key: "webhooks.cors",
                        ...
                        OneSignal.config.userConfig.notificationClickHandlerMatch ? e.push(ve.ZP.put("Options", {
                        ...
                        OneSignal.config.userConfig.notificationClickHandlerAction ? e.push(ve.ZP.put("Options", {
                ...
                static handleAutoResubscribe(e) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (C.Z.info("handleAutoResubscribe", {
                            autoResubscribe: OneSignal.config.userConfig.autoResubscribe,
                            isOptedOut: e
                        }),
                        OneSignal.config.userConfig.autoResubscribe && !e) {
                            (yield OneSignal.context.permissionManager.getNotificationPermission(OneSignal.context.appConfig.safariWebId)) == Bt.Granted && (yield fi.registerForPush())
                        }
                    }
                    ))
                }
            ...
            class Pi {
                ...
                checkIfSlidedownShouldBeShown(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var t;
                        const i = (yield OneSignal.context.permissionManager.getPermissionStatus()) === Bt.Denied;
                        let n;
                        const o = yield OneSignal.context.subscriptionManager.getSubscriptionState()
                          , {subscribed: s, optedOut: r} = o
                          , a = null === (t = e.slidedownPromptOptions) || void 0 === t ? void 0 : t.type;
                        let l = !1;
                        if (a && (l = Y.isSlidedownPushDependent(a)),
                        l) {
                            if (s)
                                return !!e.isInUpdateMode || (C.Z.info(new AlreadySubscribedError),
                                !1);
                            if (n = mi.wasPromptOfTypeDismissed(oi.Push),
                            r)
                                throw new NotSubscribedError(vt.OptedOut);
                            if (i)
                                return C.Z.info(new PushPermissionNotGrantedError(Rt.Blocked)),
                                !1
                        } else {
                            if (!e.force) {
                                const e = yield OneSignal.coreDirector.hasSms()
                                  ...
                                  , i = e && t;
                                if (e && a === B.Sms)
                                    return C.Z.info(new ui(B.Sms)),
                                    !1;
                                if (t && a === B.Email)
                                    return C.Z.info(new ui(B.Email)),
                                    !1;
                                if (i && a === B.SmsAndEmail)
                                    return C.Z.info(new ui(B.SmsAndEmail)),
                                    !1
                            }
                            n = mi.wasPromptOfTypeDismissed(oi.NonPush)
                        }
                        return !(n && !e.force && !e.isInUpdateMode) || (C.Z.info(new PermissionMessageDismissedError(a)),
                        !1)
                    }
                    ))
                }
                ...
                handleAllowForCategoryType() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (!this.slidedown)
                            throw new O.Z("SlidedownManager: handleAllowForCategoryType: this.slidedown is undefined");
                ...
                handleAllowForEmailType() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e, t, i;
                        if (!this.slidedown)
                            throw new O.Z("SlidedownManager: handleAllowForEmailType: this.slidedown is undefined");
                        const n = null === (e = this.slidedown.channelCaptureContainer) || void 0 === e ? void 0 : e.emailInputFieldIsValid
                          , o = null === (t = this.slidedown.channelCaptureContainer) || void 0 === t ? void 0 : t.isEmailInputFieldEmpty();
                        if (!n || o)
                            throw new li(ni.InvalidEmail);
                        const s = null === (i = this.slidedown.channelCaptureContainer) || void 0 === i ? void 0 : i.getValueFromEmailInput();
                        this.updateEmail(s)
                    }
                    ))
                }
                handleAllowForSmsType() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e, t, i;
                        if (!this.slidedown)
                            throw new O.Z("SlidedownManager: handleAllowForSmsType: this.slidedown is undefined");
                        const n = null === (e = this.slidedown.channelCaptureContainer) || void 0 === e ? void 0 : e.smsInputFieldIsValid
                          , o = null === (t = this.slidedown.channelCaptureContainer) || void 0 === t ? void 0 : t.isSmsInputFieldEmpty();
                        if (!n || o)
                            throw new li(ni.InvalidSms);
                        const s = null === (i = this.slidedown.channelCaptureContainer) || void 0 === i ? void 0 : i.getValueFromSmsInput();
                        this.updateSMS(s)
                    }
                    ))
                }
                handleAllowForSmsAndEmailType() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e, t, i, n, o, s;
                        if (!this.slidedown)
                            throw new O.Z("SlidedownManager: handleAllowForSmsAndEmailType: this.slidedown is undefined");
                        const r = null === (e = this.slidedown.channelCaptureContainer) || void 0 === e ? void 0 : e.smsInputFieldIsValid
                          , a = null === (t = this.slidedown.channelCaptureContainer) || void 0 === t ? void 0 : t.emailInputFieldIsValid
                          , l = null === (i = this.slidedown.channelCaptureContainer) || void 0 === i ? void 0 : i.isEmailInputFieldEmpty()
                          , d = null === (n = this.slidedown.channelCaptureContainer) || void 0 === n ? void 0 : n.isSmsInputFieldEmpty();
                        if (!r && !a || l && d)
                            throw new li(ni.InvalidEmailAndSms);
                        const c = null === (o = this.slidedown.channelCaptureContainer) || void 0 === o ? void 0 : o.getValueFromEmailInput()
                          , u = null === (s = this.slidedown.channelCaptureContainer) || void 0 === s ? void 0 : s.getValueFromSmsInput();
                        if (!a)
                            throw new li(ni.InvalidEmail);
                        if (l || this.updateEmail(c),
                        !r)
                            throw new li(ni.InvalidSms);
                        d || this.updateSMS(u)
                    }
                ...
                showConfirmationToast() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (!this.slidedown)
                            throw new O.Z("SlidedownManager: showConfirmationToast: this.slidedown is undefined");
                ...
                mountTaggingContainer(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        try {
                            ...
                            e.isInUpdateMode && r ? (this.context.tagManager.storeRemotePlayerTags(r),
                            i = J.convertTagsApiToBooleans(r)) : J.markAllTagsAsSpecified(o, !0),
                            n.mount(o, i)
                        } catch (e) {
                            C.Z.error("OneSignal: Attempted to create tagging container with error", e)
                        }
                    }
                    ))
                }
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        try {
                            if (e.slidedownPromptOptions) {
                                ...
                                t.mount(),
                                this.slidedown && (this.slidedown.channelCaptureContainer = t)
                            }
                        } catch (e) {
                            C.Z.error("OneSignal: Attempted to create channel capture container with error", e)
                        }
                    }
                    ))
                }
                handleAllowClick() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if (!this.slidedown)
                            throw new O.Z("SlidedownManager: handleAllowClick: this.slidedown is undefined");
                        const e = this.slidedown.options.type;
                        this.slidedown.isShowingFailureState && this.slidedown.removeFailureState();
                        try {
                            switch (e) {
                            case B.Push:
                                this.registerForPush();
                            ...
                            return C.Z.warn("OneSignal Slidedown failed to update:", e),
                            this.slidedown.removeSaveState(),
                            this.slidedown.setFailureState(),
                            void (void 0 !== e.reason && this.slidedown.setFailureStateForInvalidChannelInput(e.reason))
                        }
                        switch (this.slidedown && (this.slidedown.close(),
                        Y.isSlidedownPushDependent(e) || (yield this.showConfirmationToast()),
                        yield P(1e3),
                        di.triggerSlidedownEvent(di.EVENTS.CLOSED)),
                        e) {
                        case B.Push:
                        case B.Category:
                            C.Z.debug("Setting flag to not show the slidedown to the user again."),
                ...
                createSlidedown(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        try {
                            ...
                            return void C.Z.warn("checkIfSlidedownShouldBeShown returned an error", e)
                        }
                        if (function() {
                        ...
                        this.isSlidedownShowing)
                            ...
                            try {
                                ...
                                C.Z.error("There was an error showing the OneSignal Slidedown:", e),
            ...
            class Ti {
                ...
                spawnAutoPrompts() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        const i = OneSignal.config.userConfig.promptOptions
                          ...
                          , a = n && r;
                        if (r && !a)
                            return void this.internalShowDelayedPrompt(B.Native, o.timeDelay || 0);
                        const l = !!Y.getFirstSlidedownPromptOptionsWithType(null === (e = i.slidedown) || void 0 === e ? void 0 : e.prompts, B.Push);
                        a && !l && this.internalShowDelayedPrompt(B.Push, o.timeDelay || 0);
                        const d = null === (t = i.slidedown) || void 0 === t ? void 0 : t.prompts;
                ...
                internalShowDelayedPrompt(e, t, i) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        if (v.Z.logMethodCall("internalShowDelayedPrompt"),
                        "number" != typeof t)
                            return void C.Z.error("internalShowDelayedPrompt: timeDelay not a number");
                        const {requiresUserInteraction: n} = d.getEnvironmentInfo();
                        switch (n && e === B.Native && (e = B.Push),
                        t > 0 && (yield P(1e3 * t)),
                        e) {
                        case B.Native:
                ...
                internalShowNativePrompt() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        this.isNativePromptShowing ? C.Z.debug("Already showing autoprompt. Abort showing a native prompt.") : (this.isNativePromptShowing = !0,
                ...
                internalShowSlidedownPrompt(e={
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        yield this.context.slidedownManager.createSlidedown(e)) : C.Z.debug("Not showing slidedown permission message because styles failed to load.")
                    }
                    ))
                }
                ...
                internalShowParticularSlidedown(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        const o = null === (n = null === (i = this.context.appConfig.userConfig.promptOptions) || void 0 === i ? void 0 : i.slidedown) || void 0 === n ? void 0 : n.prompts
                          , s = (null == t ? void 0 : t.slidedownPromptOptions) || Y.getFirstSlidedownPromptOptionsWithType(o, e);
                        if (!s) {
                            if (e !== B.Push)
                                return void C.Z.error(`OneSignal: slidedown of type '${e}' couldn't be shown. Check your configuration on the OneSignal dashboard or your custom code initialization.`);
                            C.Z.warn("The OneSignal 'push' slidedown will be shown with default text settings. To customize, see the OneSignal documentation.")
                        }
                ...
                installEventHooksForSlidedown() {
                    ...
                    OneSignal.emitter.on(di.EVENTS.ALLOW_CLICK, ( () => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        yield this.context.slidedownManager.handleAllowClick(),
                        be.Z.trigger(OneSignal.EVENTS.TEST_FINISHED_ALLOW_CLICK_HANDLING)
                    }
                    )))),
                    OneSignal.emitter.on(di.EVENTS.CANCEL_CLICK, ( () => {
                        ...
                        if (!this.context.slidedownManager.slidedown)
                            return;
                        switch (null === (e = this.context.slidedownManager.slidedown) || void 0 === e ? void 0 : e.options.type) {
                        case B.Push:
                        case B.Category:
                            C.Z.debug("Setting flag to not show the slidedown to the user again."),
                            mi.markPromptDismissedWithType(oi.Push);
                    ...
                    case B.SmsAndEmail:
                        {
                            const {userConfig: e} = this.context.appConfig
                              , r = Y.getFirstSlidedownPromptOptionsWithType((null === (n = null === (i = e.promptOptions) || void 0 === i ? void 0 : i.slidedown) || void 0 === n ? void 0 : n.prompts) || [], t);
                            return {
                                enabled: !!r,
                                autoPrompt: !!(null == r ? void 0 : r.autoPrompt),
                                timeDelay: null === (o = null == r ? void 0 : r.delay) || void 0 === o ? void 0 : o.timeDelay,
                                pageViews: null === (s = null == r ? void 0 : r.delay) || void 0 === s ? void 0 : s.pageViews
                            }
                        }
                    default:
                        return r
            ...
            class Ni extends Ut {
                constructor(e) {
                    ...
                    sn.emitter.on(sn.EVENTS.NOTIFICATION_PERMISSION_CHANGED_AS_STRING, (e => {
                        this._permissionNative = e,
                        this._permission = e === Bt.Granted
                    }
                    ))
                ...
                setDefaultUrl(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((0,
                        T.tI)("setDefaultUrl", e),
                        void 0 === e)
                            throw new InvalidArgumentError.R("url",InvalidArgumentError.Q.Empty);
                        if ("string" != typeof e)
                            throw new InvalidArgumentError.R("url",InvalidArgumentError.Q.WrongType);
                        if (!yt.isValidUrl(e, {
                            allowNull: !0
                        }))
                            throw new InvalidArgumentError.R("url",InvalidArgumentError.Q.Malformed);
                        ...
                        T.JX)(),
                        (0,
                        T.tI)("setDefaultNotificationUrl", e);
                        const t = yield ve.ZP.getAppState();
                ...
                setDefaultTitle(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((0,
                        T.tI)("setDefaultTitle", e),
                        void 0 === e)
                            throw new InvalidArgumentError.R("title",InvalidArgumentError.Q.Empty);
                        if ("string" != typeof e)
                            throw new InvalidArgumentError.R("title",InvalidArgumentError.Q.WrongType);
                        yield(0,
                        T.JX)();
                        const t = yield ve.ZP.getAppState();
                ...
                isPushSupported() {
                    return (0,
                    T.tI)("isPushNotificationsSupported"),
                    !0
                }
                requestPermission() {
                    return (0,
            ...
            class Ai {
                ...
                update(e, t, i, n) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        this._mutexLocked = !0,
                        this._mutexPromise = new Promise(( (s, r) => (0,
                        o.mG)(this, void 0, void 0, (function*() {
                            (0,
                            T.tI)("ModelCache.update", {
                                modelName: e,
                                modelId: t,
                                key: i,
                                value: n
                            ...
                            o || r("ModelCache: Attempting to update a model that does not exist"),
                            o && (o[i] = n,
                            yield ve.ZP.put(e, o),
                            this._mutexLocked = !1,
                            s()),
                            setTimeout(r.bind(this, "Database promise never resolved."), 1e4)
                        }
                        ))))
                    }
                    ))
                ...
                get(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        try {
                            return yield this._mutexPromise,
                            yield ve.ZP.get(e, t)
                        } catch (e) {
                            return
                        }
                ...
                getCachedEncodedModels(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        return (0,
                        T.tI)("ModelCache.getCachedEncodedModels", {
                            modelName: e
                        }),
                ...
                getAndDecodeModelsWithModelName(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("ModelCache.getAndDecodeModelsWithModelName", {
                            modelName: e
                        });
                        const t = yield this.getCachedEncodedModels(e);
                        if (0 !== Object.keys(t).length)
                            return t.map(kt.decode)
                    }
                    ))
                }
                reset() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("ModelCache.reset");
                        const e = [];
                        Object.values(xt.Q).forEach((t => (0,
                        o.mG)(this, void 0, void 0, (function*() {
            ...
            class Mi extends Ot {
                ...
                processModelUpdated(e) {
                    var t;
                    (0,
                    T.tI)("processModelUpdated", {
                        modelStoreChange: e
                    });
                    const {modelId: i, payload: n} = e;
                    if (this.modelCache.update(n.model.modelName, i, n.property, n.newValue),
                    n.oldValue !== n.newValue) {
                        const e = {
                            ...
                            oldValue: n.oldValue,
                            newValue: n.newValue,
                            applyToRecordId: null === (t = n.model) || void 0 === t ? void 0 : t.applyToRecordId
                        };
                        this.broadcast(e)
                    }
                }
            ...
            function Ui(e) {
                ...
                if (!t)
                    throw new O.Z(`processSubscriptionModel: bad subscription OSModel<SubscriptionModel>: ${JSON.stringify(t)}`);
                if (void 0 === (null == (n = i) ? void 0 : n.type))
                    throw new O.Z(`processSubscriptionModel: bad subscription object: ${JSON.stringify(i)}`);
                var n;
                if (!t.onesignalId)
                    throw new O.Z(`processSubscriptionModel: missing onesignalId: ${JSON.stringify(t)}`);
                let o;
                return Dt(i) && (o = null == i ? void 0 : i.id),
                {
                    subscription: i,
            ...
            function Gi(e) {
                ...
                if (!Mt(i))
                    throw new O.Z(`processIdentityModel: bad identity object: ${JSON.stringify(i)}`);
                const {onesignal_id: n} = i
                  , o = JSON.parse(JSON.stringify(i));
                if (delete o.onesignal_id,
                !n)
                    throw new O.Z(`processIdentityModel: missing onesignalId: ${JSON.stringify(i)}`);
                return {
                    identity: o,
                    aliasPair: new w(w.ONESIGNAL_ID,n)
                }
            }
            class Bi {
                ...
                static removeIdentity(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((0,
                        T.tI)("removeIdentity", e),
                        !e.payload)
                            throw new O.Z("removeIdentity: operation.payload is not defined");
                        if (1 !== Object.keys(e.payload).length)
                            throw new O.Z("removeIdentity: operation.payload must have exactly one key");
                        const t = yield wt.getAppId()
                          , i = Object.keys(e.payload)[0]
                          , {aliasPair: n} = Gi(e)
                          , o = yield _.deleteAlias({
                            appId: t
                        }, n, i);
                        return Bi._processIdentityResponse(o)
                    }
                ...
                static _processIdentityResponse(e) {
                    ...
                    if (t >= 200 && t < 300) {
                        if (!Mt(n))
                            throw new O.Z(`processIdentityResponse: result ${n} is not an identity object`);
                        return new Di(n)
                    }
            ...
            class Ri {
                static addSubscription(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("SubscriptionRequests.addSubscription", e);
                        const t = yield wt.getAppId()
                          , {subscription: i, aliasPair: n, subscriptionId: o} = Ui(e)
                          , s = yield _.createSubscription({
                            appId: t
                        }, n, {
                            subscription: i
                        })
                          , r = s.status;
                        return r >= 200 && r < 300 && OneSignal.coreDirector.getNewRecordsState().add(o),
                ...
                static removeSubscription(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("SubscriptionRequests.removeSubscription", e);
                        const {subscriptionId: t} = Ui(e);
                        if (!t)
                            throw new O.Z("removeSubscription: subscriptionId is not defined");
                        const i = yield wt.getAppId()
                          , n = yield _.deleteSubscription({
                            appId: i
                        }, t);
                ...
                static updateSubscription(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("SubscriptionRequests.updateSubscription", e);
                        const {payload: t, subscriptionId: i} = Ui(e);
                        if (!i)
                            throw new O.Z("updateSubscription: subscriptionId is not defined");
                        if (!t)
                            throw new O.Z("updateSubscription: payload is not defined");
                        const n = yield wt.getAppId()
                          , o = yield _.updateSubscription({
                            appId: n
                        }, i, t);
                ...
                static _processSubscriptionResponse(e) {
                    ...
                    if (t >= 200 && t < 300) {
                        if (n && !Dt(n))
                            throw new O.Z(`processSubscriptionResponse: bad subscription object: ${n}`);
                        return new Di(n)
                    }
                    return t >= 400 && t < 500 ? new Zi : new _i
                }
            ...
            class Li {
                static updateUserProperties(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("UserPropertyRequests.updateUserProperties", e);
                        const t = e.model
                          , i = null == t ? void 0 : t.data;
                        if (!i || !t)
                            throw new O.Z(`updateUserProperty: bad identity model: ${t}`);
                        if (!t.onesignalId)
                            return C.Z.info("Caching User Property update until subscription is created."),
                            new Zi;
                        const n = new w(w.ONESIGNAL_ID,t.onesignalId)
                          , o = yield wt.getAppId()
                          , s = yield OneSignal.coreDirector.getPushSubscriptionModel();
                        let r;
                        Dt(null == s ? void 0 : s.data) && (r = null == s ? void 0 : s.data.id);
                        const a = yield _.updateUser({
                            appId: o,
                            subscriptionId: r
                        }, n, {
                            properties: i
                ...
                static _processUserPropertyResponse(e) {
                    ...
                    const {status: t, result: i} = e;
                    return t >= 200 && t < 300 ? new Di(null == i ? void 0 : i.properties) : t >= 400 && t < 500 ? new Zi : new _i
                }
            }
            const Fi = {
            ...
            class Wi {
                constructor(e, t, i) {
                    ...
                    this.applyToRecordId = null === (n = null == i ? void 0 : i[i.length - 1]) || void 0 === n ? void 0 : n.applyToRecordId,
                    this.timestamp = Date.now(),
                    this.jwtTokenAvailable = new Promise((e => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        this.jwtToken = yield ve.ZP.getJWTToken(),
                        e()
                    }
                    ))))
                }
                ...
                aggregateDeltas(e) {
                    ...
                    return e.forEach((e => {
                        if (Nt(e)) {
                            ...
                            const o = i && n
                              , s = Object.assign(Object.assign({}, t[e.property]), e.newValue);
                ...
                static getInstanceWithModelReference(e) {
                    var t;
                    const {operationId: i, payload: n, modelName: o, changeType: s, timestamp: r, model: a} = e;
                    if (!a)
                        throw new O.Z("Operation.fromJSON: model is undefined");
                    const l = null === (t = OneSignal.coreDirector) || void 0 === t ? void 0 : t.getModelByTypeAndId(o, a.modelId);
                    if (l) {
                        const t = new Wi(s,o);
                        return t.model = l,
                        t.operationId = i,
                    ...
                    throw new Error(`Could not find model with id ${a.modelId} of type ${o}. Maybe user logged out?`)
                }
            }
            class $i {
                static enqueue(e) {
                    (0,
                    T.tI)("OperationCache.enqueue", {
                        operation: e
                    });
                ...
                static getOperationsWithModelName(e) {
                    ...
                    for (let e = 0; e < i.length; e++) {
                        ...
                        try {
                            ...
                            C.Z.warn(`Could not parse operation ${t.operationId} from cache`, e),
                            this.delete(t.operationId)
                        }
                    }
                    return n.sort(( (e, t) => e.timestamp - t.timestamp)).filter((t => t.modelName === e))
                }
                static delete(e) {
                    (0,
                    T.tI)("OperationCache.delete", {
                        id: e
                    });
                    const t = localStorage.getItem("operationCache")
                      , i = t ? JSON.parse(t) : {};
                ...
                static flushOperations() {
                    (0,
                    T.tI)("OperationCache.flushOperations"),
            ...
            class ji {
                constructor(e, t) {
                    ...
                    this.onlineStatus = !0,
                    setInterval(( () => {
                        C.Z.debug("OneSignal: checking for operations to process from cache");
                        const e = this.getOperationsFromCache();
                        this._operationQueue = [...e, ...this._operationQueue],
                        this._operationQueue.length > 0 && this._processOperationQueue.call(this)
                    }
                    ), 1e3 * ji.OPERATIONS_BATCH_PROCESSING_TIME),
                    window.addEventListener("online", this._onNetworkChange.bind(this, !0)),
                    window.addEventListener("offline", this._onNetworkChange.bind(this, !1)),
                ...
                enqueueDelta(e) {
                    (0,
                    T.tI)("ExecutorBase.enqueueDelta", {
                        delta: e
                    });
                ...
                _enqueueOperation(e) {
                    (0,
                    T.tI)("ExecutorBase.enqueueOperation", {
                        operation: e
                    }),
                ...
                _flushOperations() {
                    (0,
                    T.tI)("ExecutorBase._flushOperations"),
                    this._operationQueue = []
                }
                _getChangeType(e, t) {
                    (0,
                    T.tI)("ExecutorBase._getChangeType", {
                        oldValue: e,
                        newValue: t
                    });
                    const i = !!e && !t
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!e || t)
                            for (; this._operationQueue.length > 0; ) {
                                ...
                                e && ($i.enqueue(e),
                                this._canExecute(e) && this._processOperation(e, ji.RETRY_COUNT).catch((e => {
                                    C.Z.error(e)
                                }
                                )))
                            }
                ...
                _processOperation(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var i, n, o, s, r;
                        (0,
                        T.tI)("ExecutorBase._processOperation", {
                            operation: e,
                            retries: t
                        }),
                        yield null === (i = e.model) || void 0 === i ? void 0 : i.awaitOneSignalIdAvailable,
                        yield e.jwtTokenAvailable;
                        let a = {
                            success: !1,
                            retriable: !0
                        };
                        if ((null == e ? void 0 : e.changeType) === bt.Add ? a = yield null === (n = this._executeAdd) || void 0 === n ? void 0 : n.call(this, e) : (null == e ? void 0 : e.changeType) === bt.Remove ? a = yield null === (o = this._executeRemove) || void 0 === o ? void 0 : o.call(this, e) : (null == e ? void 0 : e.changeType) === bt.Update && (a = yield null === (s = this._executeUpdate) || void 0 === s ? void 0 : s.call(this, e)),
                        a.success) {
                            if (a.result) {
                                const t = yield Wi.getInstanceWithModelReference(e);
                                null === (r = null == t ? void 0 : t.model) || void 0 === r || r.hydrate(a.result)
                            }
                            $i.delete(null == e ? void 0 : e.operationId)
                        } else
                            a.retriable && t > 0 ? setTimeout(( () => {
                                this._processOperation(e, t - 1).catch((e => {
                                    C.Z.error(e)
                                }
                                ))
                            }
                            ), 5e3) : $i.delete(null == e ? void 0 : e.operationId)
                    }
                    ))
                }
                _onNetworkChange(e) {
                    (0,
                    T.tI)("ExecutorBase._onNetworkChange", {
                        online: e
                    }),
                    this.onlineStatus = e,
                ...
                _canExecute(e) {
                    return !!this.onlineStatus && !(e.applyToRecordId && !this._newRecordsState.canAccess(e.applyToRecordId))
                }
            }
            ji.OPERATIONS_BATCH_PROCESSING_TIME = 5,
            ji.RETRY_COUNT = 5;
            class Hi extends ji {
                constructor(e, t) {
                    super(e, t)
                ...
                processDeltaQueue() {
                    ...
                    this._deltaQueue.forEach((i => {
                        ...
                        n === bt.Add || n === bt.Update ? e.push(i) : n === bt.Remove && t.push(i)
                    }
                    )),
                    e.length > 0 && this._enqueueOperation(new Wi(bt.Add,xt.Q.Identity,e)),
                    t.length > 0 && this._enqueueOperation(new Wi(bt.Remove,xt.Q.Identity,t)),
                    this._flushDeltas()
                }
            ...
            class Qi extends ji {
                ...
                processDeltaQueue() {
                    0 !== this._deltaQueue.length && (this._enqueueOperation(new Wi(bt.Update,xt.Q.Properties,this._deltaQueue)),
                    this._flushDeltas())
                }
                getOperationsFromCache() {
            ...
            class qi extends ji {
                ...
                processDeltaQueue() {
                    this.separateDeltasByModelId().forEach((e => {
                        ...
                        Object.keys(t).forEach((e => {
                            const i = t[e];
                            i.length > 0 && this._enqueueOperation(new Wi(e,i[0].model.modelName,i))
                        }
                        ))
                    }
                    )),
                ...
                separateDeltasByModelId() {
                    const e = {};
                    return this._deltaQueue.forEach((t => {
            ...
            class Ji {
                constructor(e, t) {
                    ...
                    this._unsubscribeFromModelRepo = this.modelRepo.subscribe((e => {
                ...
                _processDelta(e) {
                    (0,
                    T.tI)("OperationRepo._processDelta", {
                        delta: e
                    });
                    const t = JSON.parse(JSON.stringify(e));
                    this._deltaQueue.push(t)
                ...
                _processDeltaQueue() {
                    (0,
                    T.tI)("OperationRepo._processDeltaQueue"),
                    this._deltaQueue.forEach((e => {
                        var t;
                        const {modelName: i} = e.model;
                        null === (t = this.executorStore.store[i]) || void 0 === t || t.enqueueDelta(e)
                    }
                    )),
            ...
            class Yi extends Ot {
                ...
                add(e, t) {
                    this.subscribeUpdateListener(e),
                    this.models[e.modelId] = e,
                    t ? this.broadcast(new Et(e.modelId,e)) : this.broadcast(new Tt(e.modelId,e))
                }
                remove(e) {
                ...
                subscribeUpdateListener(e) {
                    this.unsubscribeCallbacks[e.modelId] = e.subscribe((t => {
                        const {payload: i} = t;
                        var n;
                        t.type === bt.Update && (null !== (n = i) && "object" == typeof n && (null == n ? void 0 : n.constructor) === It) ? this.broadcast(new Pt(e.modelId,i)) : t.type === bt.Hydrate && function(e) {
                            return null !== e && "object" == typeof e && (null == e ? void 0 : e.constructor) === kt
                        }(i) && this.broadcast(new Tt(e.modelId,i))
                    }
                    ))
                }
            }
            class Xi {
                static build(e) {
                    const t = {};
                    return Object.values(xt.Q).forEach((i => {
            ...
            class en {
                constructor(e=3e3) {
                    ...
                    this.OP_REPO_POST_CREATE_DELAY = e
                }
                add(e, t=!1) {
            ...
            class tn {
                constructor() {
                    ...
                    this.modelCache.load(Mi.supportedModels).then((e => {
                        const t = Xi.build(e);
                        this.modelRepo = new Mi(this.modelCache,t),
                        this.newRecordsState = new en,
                        this.operationRepo = new Ji(this.modelRepo,this.newRecordsState),
                        this.initResolver()
                    }
                    )).catch((e => {
                        C.Z.error(e)
                ...
                resetModelRepoAndCache() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var e;
                        (0,
                        T.tI)("CoreModule.resetModelRepo"),
                        yield this.modelCache.reset();
                        const t = Xi.build();
                        this.modelRepo = new Mi(this.modelCache,t),
                        null === (e = this.operationRepo) || void 0 === e || e.setModelRepoAndResubscribe(this.modelRepo)
                    }
                    ))
                }
                forceDeltaQueueProcessingOnAllExecutors() {
                    var e;
                    null === (e = this.operationRepo) || void 0 === e || e.forceDeltaQueueProcessingOnAllExecutors()
                }
            }
            class nn {
                constructor(e) {
                ...
                generatePushSubscriptionModel(e) {
                    (0,
                    T.tI)("CoreModuleDirector.generatePushSubscriptionModel", {
                ...
                hydrateUser(e, t) {
                    (0,
                    T.tI)("CoreModuleDirector.hydrateUser", {
                        user: e,
                        externalId: t
                    });
                    try {
                        ...
                        if (!o)
                            throw new O.Z("OneSignal ID is missing from user data");
                        null == i || i.setOneSignalId(o),
                        null == n || n.setOneSignalId(o),
                        t && (null == i || i.setExternalId(t),
                ...
                _hydrateSubscriptions(e, t, i) {
                    if ((0,
                    T.tI)("CoreModuleDirector._hydrateSubscriptions", {
                        subscriptions: e,
                        onesignalId: t,
                        externalId: i
                    }),
                    ...
                    e.forEach((e => (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        const o = e.token ? this.getSubscriptionOfTypeWithToken(fi.toSubscriptionChannel(e.type), e.token) : void 0;
                        if (o)
                            o.setOneSignalId(t),
                ...
                forceDeltaQueueProcessingOnAllExecutors() {
                    (0,
                    T.tI)("CoreModuleDirector.forceDeltaQueueProcessingOnAllExecutors"),
                    this.core.forceDeltaQueueProcessingOnAllExecutors()
                }
                add(e, t, i=!0) {
                    (0,
                    T.tI)("CoreModuleDirector.add", {
                        modelName: e,
                        model: t
                    });
                ...
                remove(e, t) {
                    (0,
                    T.tI)("CoreModuleDirector.remove", {
                        modelName: e,
                        modelId: t
                    });
                ...
                getModelByTypeAndId(e, t) {
                    (0,
                    T.tI)("CoreModuleDirector.getModelByTypeAndId", {
                        modelName: e,
                        modelId: t
                    });
                ...
                getEmailSubscriptionModels() {
                    (0,
                    T.tI)("CoreModuleDirector.getEmailSubscriptionModels");
                    const e = this.getModelStores().subscriptions.models;
                    return Object.fromEntries(Object.entries(e).filter(( ([,e]) => {
                        var t;
                        return (null === (t = e.data) || void 0 === t ? void 0 : t.type) === c.Email
                    }
                    )))
                }
                hasEmail() {
                ...
                getSmsSubscriptionModels() {
                    (0,
                    T.tI)("CoreModuleDirector.getSmsSubscriptionModels");
                    const e = this.getModelStores().subscriptions.models;
                    return Object.fromEntries(Object.entries(e).filter(( ([,e]) => {
                        var t;
                        return (null === (t = e.data) || void 0 === t ? void 0 : t.type) === c.SMS
                    }
                    )))
                }
                hasSms() {
                ...
                getAllPushSubscriptionModels() {
                    (0,
                    T.tI)("CoreModuleDirector.getAllPushSubscriptionModels");
                    const e = this.getModelStores().subscriptions.models;
                    return Object.fromEntries(Object.entries(e).filter(( ([,e]) => {
                        var t;
                        return fi.isPushSubscriptionType(null === (t = e.data) || void 0 === t ? void 0 : t.type)
                    }
                    )))
                }
                getPushSubscriptionModelByCurrentToken() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (e)
                            return this.getSubscriptionOfTypeWithToken(u.Push, e)
                    }
                    ))
                }
                ...
                getPushSubscriptionModel() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        return (0,
                        T.tI)("CoreModuleDirector.getPushSubscriptionModel"),
                        (yield this.getPushSubscriptionModelByCurrentToken()) || (yield this.getPushSubscriptionModelByLastKnownToken())
                    }
                    ))
                }
                getIdentityModel() {
                    (0,
                    T.tI)("CoreModuleDirector.getIdentityModel");
                ...
                getPropertiesModel() {
                    (0,
                    T.tI)("CoreModuleDirector.getPropertiesModel");
                    const e = this.getModelStores()
                ...
                getAllSubscriptionsModels() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("CoreModuleDirector.getAllSubscriptionsModels");
                        const e = this.getEmailSubscriptionModels()
                          , t = this.getSmsSubscriptionModels()
                          , i = yield this.getPushSubscriptionModel();
                        return Object.values(e).concat(Object.values(t)).concat(i ? [i] : [])
                    }
                    ))
                }
                getSubscriptionOfTypeWithToken(e, t) {
                    let i;
                    switch ((0,
                    T.tI)("CoreModuleDirector.getSubscriptionOfTypeWithToken", {
                        type: e,
                        token: t
                    }),
                    e) {
                ...
                getModelStores() {
                    var e;
                    return null === (e = this.core.modelRepo) || void 0 === e ? void 0 : e.modelStores
                }
            }
            class on {
                static login(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (o && !s)
                            throw new O.Z("Login: Consent required but not given, skipping login");
                        try {
                            ...
                            const r = null === (i = null == o ? void 0 : o.data) || void 0 === i ? void 0 : i.external_id;
                            if (r === e)
                                return void C.Z.debug("Login: External ID already set, skipping login");
                            const a = yield sn.coreDirector.getPushSubscriptionModel();
                            let l;
                            a && Dt(a.data) && (l = a.data.id);
                            const d = on.isIdentified(o.data);
                            let c;
                            if (on.setExternalId(o, e),
                            d) {
                                c = {
                                    identity: {
                                        external_id: e
                                ...
                                c = yield _t.getAllUserData();
                            yield sn.coreDirector.resetModelRepoAndCache(),
                            yield _t.initializeUser(!0);
                            try {
                                const t = yield on.identifyOrUpsertUser(c, d, l)
                                  , i = null === (n = null == t ? void 0 : t.identity) || void 0 === n ? void 0 : n.onesignal_id;
                                if (!i)
                                    return void C.Z.info("Caching login call, waiting on network or subscription creation.");
                                yield on.fetchAndHydrate(i, e)
                            } catch (e) {
                                if (C.Z.error(`Login: Error while identifying/upserting user: ${e.message}`),
                                s) {
                                    C.Z.debug("Login: Restoring old user data");
                                    try {
                                        yield on.fetchAndHydrate(s, r)
                                    } catch (e) {
                                        C.Z.error(`Login: Error while restoring old user data: ${e.message}`)
                                    }
                                }
                                throw e
                            }
                ...
                static logout() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!e || !e.data || !e.data.external_id)
                            return void C.Z.debug("Logout: User is not logged in, skipping logout");
                        sn.coreDirector.forceDeltaQueueProcessingOnAllExecutors(),
                        _t.resetUserMetaProperties();
                        const t = yield sn.coreDirector.getPushSubscriptionModel();
                        null == t || t.setExternalId(void 0),
                        yield sn.coreDirector.resetModelRepoAndCache(),
                        void 0 !== t ? (sn.coreDirector.add(xt.Q.Subscriptions, t, !1),
                        yield _t.initializeUser(!1)) : yield _t.initializeUser(!0)
                    }
                    ))
                }
                static setExternalId(e, t) {
                    if ((0,
                    T.tI)("LoginManager.setExternalId", {
                        externalId: t
                    }),
                    !e)
                        throw new O.Z("login: no identity model found");
                ...
                static isIdentified(e) {
                    return (0,
                    T.tI)("LoginManager.isIdentified", {
                        identity: e
                    }),
                ...
                static identifyOrUpsertUser(e, t, i) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        let n;
                        return (0,
                        T.tI)("LoginManager.identifyOrUpsertUser", {
                            userData: e,
                            isIdentified: t,
                            subscriptionId: i
                        }),
                        n = t ? yield this.upsertUser(e, i) : yield this.identifyUser(e, i),
                        n
                    }
                    ))
                }
                static upsertUser(e, t, i=5) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (u >= 200 && u < 300) {
                            const t = null === (n = e.identity) || void 0 === n ? void 0 : n.onesignal_id
                              , i = sn.coreDirector.getNewRecordsState();
                            i || C.Z.error("UpsertUser: NewRecordsState is undefined"),
                            t && (null == i || i.add(t));
                            const a = null === (s = null === (o = e.subscriptions) || void 0 === o ? void 0 : o[0]) || void 0 === s ? void 0 : s.token
                              , l = null === (r = c.subscriptions) || void 0 === r ? void 0 : r.find((e => e.token === a));
                            l && Dt(l) && (null == i || i.add(l.id)),
                            C.Z.info("Successfully created user", c)
                        } else if (u >= 400 && u < 500)
                            C.Z.error("Malformed request", c);
                        else if (u >= 500)
                            return C.Z.error("Server error. Retrying..."),
                            yield P(k[i]),
                ...
                static identifyUser(e, t, i=5) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        var n;
                        if ((0,
                        T.tI)("LoginManager.identifyUser", {
                            userData: e,
                            pushSubscriptionId: t
                        }),
                        0 === i)
                            throw new O.Z("Login: identifyUser failed: max retries reached");
                        const {onesignal_id: o} = e.identity
                          , s = JSON.parse(JSON.stringify(e));
                        this.stripAliasesOtherThanExternalId(e);
                        const {identity: r} = e;
                        if (!r)
                            throw new O.Z("identifyUser failed: no identity found");
                        if (!o) {
                            const t = sn.coreDirector.getIdentityModel();
                            return null == t || t.set(w.EXTERNAL_ID, r.external_id, !1),
                            e
                        }
                        const a = yield wt.getAppId()
                        ...
                        if (c >= 200 && c < 300) {
                            ...
                            if (c >= 400 && c < 500)
                                throw new O.Z(`identifyUser: malformed request: ${JSON.stringify(null == d ? void 0 : d.result)}`);
                            if (c >= 500)
                                return C.Z.error("identifyUser failed: server error. Retrying..."),
                                yield P(k[i]),
                                this.identifyUser(s, t, i - 1)
                        }
                        return {
                            identity: null === (n = null == d ? void 0 : d.result) || void 0 === n ? void 0 : n.identity
                        }
                    }
                    ))
                }
                static fetchAndHydrate(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        (0,
                        T.tI)("LoginManager.fetchAndHydrate", {
                            onesignalId: e,
                            externalId: t
                        });
                ...
                static stripAliasesOtherThanExternalId(e) {
                    (0,
                    T.tI)("LoginManager.stripAliasesOtherThanExternalId", {
                        userData: e
                    });
                    const {identity: t} = e;
                    if (!t)
                        throw new O.Z("stripAliasesOtherThanExternalId failed: no identity found");
                    const {external_id: i} = t;
                    if (!i)
                        throw new O.Z("stripAliasesOtherThanExternalId failed: no external_id found");
                    const n = {
                        external_id: i
                    };
                    e.identity = n
                ...
                static transferSubscription(e, t, i) {
                    return (0,
                    o.mG)(this, void 0, void 0, (function*() {
                        C.Z.error("^^^ Handling 409 HTTP response reported by the browser above. This is an expected result when the User already exists. Push subscription is being transferred the existing User.");
                        const n = yield _.transferSubscription({
                            appId: e
                        }, t, i, !1)
                        ...
                        if (o && o >= 200 && o < 300) {
                            ...
                            return {
                                identity: null == s ? void 0 : s.identity
                            }
                        }
                        throw new O.Z(`transferSubscription failed: ${JSON.stringify(s)}}`)
                    }
                    ))
                }
            }
            class sn {
                static _initializeCoreModuleAndOSNamespaces() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        const e = new tn;
                        yield e.initPromise,
                        sn.coreDirector = new nn(e);
                        const t = yield ve.ZP.getSubscription()
                          , i = yield sn.context.permissionManager.getPermissionStatus();
                        sn.User = new Vt(!0,t,i),
                        this.Notifications = new Ni(i)
                    }
                    ))
                }
                ...
                static login(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        void 0 === e)
                            throw new InvalidArgumentError.R("externalId",InvalidArgumentError.Q.Empty);
                        if ("string" != typeof e)
                            throw new InvalidArgumentError.R("externalId",InvalidArgumentError.Q.WrongType);
                        if (void 0 !== t && "string" != typeof t)
                            throw new InvalidArgumentError.R("jwtToken",InvalidArgumentError.Q.WrongType);
                        yield on.login(e, t)
                    }
                    ))
                }
                ...
                static init(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((0,
                        T.tI)("init"),
                        C.Z.debug(`Browser Environment: ${(0,
                        l.M)().name} ${(0,
                        l.M)().version}`),
                        ...
                        if ("safari" != (0,
                        l.M)().name || sn.config.safariWebId) {
                            if (yield sn._initializeCoreModuleAndOSNamespaces(),
                            ...
                            C.Z.warn(new SdkInitError(M.MissingSafariWebId))
                    }
                    ))
                }
                static _delayedInit() {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        function e() {
                            return (0,
                            o.mG)(this, void 0, void 0, (function*() {
                                sn.__initAlreadyCalled || (sn.__initAlreadyCalled = !0,
                                sn.emitter.on(sn.EVENTS.NOTIFICATION_PERMISSION_CHANGED_AS_STRING, Wt.onNotificationPermissionChange),
                                sn.emitter.on(sn.EVENTS.SUBSCRIPTION_CHANGED, Wt._onSubscriptionChanged),
                                sn.emitter.on(sn.EVENTS.SDK_INITIALIZED, Ci.onSdkInitialized),
                        ...
                        "complete" === document.readyState || "interactive" === document.readyState ? yield e() : (C.Z.debug("OneSignal: Waiting for DOMContentLoaded or readyStateChange event before continuing initialization..."),
                ...
                static setConsentGiven(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((0,
                        T.tI)("setConsentGiven", {
                            consent: e
                        }),
                        void 0 === e)
                            throw new InvalidArgumentError.R("consent",InvalidArgumentError.Q.Empty);
                        if ("boolean" != typeof e)
                            throw new InvalidArgumentError.R("consent",InvalidArgumentError.Q.WrongType);
                ...
                static setConsentRequired(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        if ((0,
                        T.tI)("setConsentRequired", {
                            requiresConsent: e
                        }),
                        void 0 === e)
                            throw new InvalidArgumentError.R("requiresConsent",InvalidArgumentError.Q.Empty);
                        if ("boolean" != typeof e)
                            throw new InvalidArgumentError.R("requiresConsent",InvalidArgumentError.Q.WrongType);
            ...
            sn.Slidedown = new class extends Ut {
                ...
                promptPush(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        yield(0,
                        T.JX)(),
                        yield sn.context.promptsManager.internalShowParticularSlidedown(B.Push, e)
                    }
                    ))
                }
                promptPushCategories(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        yield(0,
                        T.JX)();
                        const t = yield sn.context.subscriptionManager.isPushNotificationsEnabled();
                        yield sn.context.promptsManager.internalShowCategorySlidedown(Object.assign(Object.assign({}, e), {
                            isInUpdateMode: t
                        }))
                    }
                    ))
                ...
                promptSms(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        yield(0,
                        T.JX)(),
                        yield sn.context.promptsManager.internalShowSmsSlidedown(Object.assign({}, e))
                    }
                    ))
                }
                promptEmail(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        yield(0,
                        T.JX)(),
                        yield sn.context.promptsManager.internalShowEmailSlidedown(Object.assign({}, e))
                    }
                    ))
                }
                promptSmsAndEmail(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        yield(0,
                        T.JX)(),
                        yield sn.context.promptsManager.internalShowSmsAndEmailSlidedown(Object.assign({}, e))
                    }
                    ))
                }
                addEventListener(e, t) {
            ...
            sn.Session = new class {
                sendOutcome(e, t) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        if (!i)
                            return void C.Z.error(`Could not send ${e}. No outcomes config found.`);
                        const n = new Ee(OneSignal.config.appId,i,e,!1);
                        if (void 0 !== t && "number" != typeof t)
                            return void C.Z.error("Outcome weight can only be a number if present.");
                ...
                sendUniqueOutcome(e) {
                    ...
                    o.mG)(this, void 0, void 0, (function*() {
                        ...
                        i.shouldSendUnique(n, s) ? yield i.send({
                            type: n.type,
                            notificationIds: s
                        }) : C.Z.warn(`'${e}' was already reported for all notifications.`)
                    }
                    ))
                }
            }
            ...
            ,
            C.Z.info(`OneSignal Web SDK loaded (version ${sn._VERSION},\n  ${p.Z.getWindowEnv().toString()} environment).`),
            C.Z.debug(`Current Page URL: ${"undefined" == typeof location ? "NodeJS" : location.href}`)
        }
        ,
        191: (e, t, i) => {
            "use strict";
        ...
        50: (e, t, i) => {
            ...
            class o {
                ...
                static parseVersionString(e) {
                    ...
                    let n;
                    return n = t[1] ? o.padStart(t[1], 2, "0") : "00",
                    Number(`${i}.${n}`)
                }
        ...
        930: (e, t, i) => {
            ...
            class a {
                ...
                static useSafariVapidPush() {
                    return "safari" == (0,
                    s.M)().name && r() && !this.useSafariLegacyPush()
                }
                static version() {
                ...
                static supportsServiceWorkers() {
                    return n.Z.getWindowEnv() === o.Q.ServiceWorker || "undefined" != typeof navigator && "serviceWorker"in navigator
                }
        ...
        326: (e, t, i) => {
            ...
            class a {
                ...
                static getOrigin() {
                    return s.Z.isBrowser() ? window.location.origin : "undefined" != typeof self && "undefined" != typeof ServiceWorkerGlobalScope ? self.location.origin : "Unknown"
                }
                static getWindowEnv() {
                    if ("undefined" == typeof window) {
                        if ("undefined" != typeof self && "undefined" != typeof ServiceWorkerGlobalScope)
                ...
                static getBuildEnvPrefix(e=a.getBuildEnv()) {
                    ...
                    case n.Production:
                        return "";
                    default:
                        throw new InvalidArgumentError.R("buildEnv",InvalidArgumentError.Q.EnumOutOfRange)
                    }
                }
                static getOneSignalApiUrl(e=a.getApiEnv(), t) {
                    ...
                    switch (e) {
                    case n.Development:
                        return a.isTurbineEndpoint(t) ? new URL(`http://${i}:18080/api/v1`) : new URL(`http://${i}:3000/api/v1`);
                    case n.Staging:
        ...
        934: (e, t, i) => {
            ...
            class l {
                ...
                onDatabaseOpenError(e) {
                    ...
                    r.Z.contains(t.message, "The operation failed for reasons unrelated to the database itself and not covered by any other error code") || r.Z.contains(t.message, "A mutation operation was attempted on a database that did not allow mutations") ? a.Z.warn("OneSignal: IndexedDb web storage is not available on this origin since this profile's IndexedDb schema has been upgraded in a newer version of Firefox. See: https://bugzilla.mozilla.org/show_bug.cgi?id=1236557#c6") : a.Z.warn("OneSignal: Fatal error opening IndexedDb database:", t)
                }
                onDatabaseError(e) {
                ...
                onDatabaseUpgradeNeeded(e) {
                    a.Z.debug("IndexedDb: Database is being rebuilt or upgraded (upgradeneeded event).");
                    const t = e.target
                      , i = t.transaction;
                    if (!i)
                    ...
                    o >= 4 && e.oldVersion < 4 && (n.createObjectStore(s.Q.Identity, {
                        keyPath: "modelId"
                    }),
                    n.createObjectStore(s.Q.Properties, {
                        keyPath: "modelId"
                    }),
                    ...
                    o >= 5 && e.oldVersion < 5 && (this.migrateOutcomesNotificationClickedTableForV5(n, i),
                    this.migrateOutcomesNotificationReceivedTableForV5(n, i)),
                    o >= 6 && e.oldVersion < 6 && this.migrateModelNameSubscriptionsTableForV6(n, i),
                    o >= 7 && e.oldVersion,
                ...
                migrateOutcomesNotificationClickedTableForV5(e, t) {
                    ...
                    o.onsuccess = () => {
                        if (!o.result)
                            return void e.deleteObjectStore(n);
                ...
                migrateOutcomesNotificationReceivedTableForV5(e, t) {
                    ...
                    const n = "NotificationReceived"
                      , o = t.objectStore(n).openCursor();
                    o.onsuccess = () => {
                        o.result ? (t.objectStore(i).put(o.result.value),
                        o.result.continue()) : e.deleteObjectStore(n)
                    }
                    ,
                    o.onerror = () => {
                ...
                migrateModelNameSubscriptionsTableForV6(e, t) {
                    ...
                    ,
                    o.onerror = () => {
                        console.error("Could not find " + s.Q.Identity + " records", o.error)
                    }
                    ,
                    Object.values(s._).forEach((o => {
                        ...
                        r.onsuccess = () => {
                            ...
                            t.objectStore(i).put(Object.assign(Object.assign({}, a), {
                        ...
                        ,
                        r.onerror = () => {
                            console.error("Could not migrate " + o + " records", r.error)
                        }
                    }
                    ))
                }
                ...
                put(e, t) {
                    ...
                    n.mG)(this, void 0, void 0, (function*() {
                        ...
                        yield new Promise(( (i, n) => {
                            var o;
                            try {
                                const s = null === (o = this.database) || void 0 === o ? void 0 : o.transaction([e], "readwrite").objectStore(e).put(t);
                                s && (s.onsuccess = () => {
                                    i(t)
                                }
                                ,
                                s.onerror = e => {
                                    a.Z.error("Database PUT Transaction Error:", e),
                                    n(e)
                                }
                                )
                            } catch (e) {
                                a.Z.error("Database PUT Error:", e),
                                n(e)
                            }
                        }
                        ))
                    ...
                    n.mG)(this, void 0, void 0, (function*() {
                        ...
                        return new Promise(( (n, o) => {
                            try {
                                ...
                                ,
                                r.onerror = e => {
                                    a.Z.error("Database REMOVE Transaction Error:", e),
                                    o(e)
                                }
                            } catch (e) {
                                a.Z.error("Database REMOVE Error:", e),
                                o(e)
                            }
                        }
                        ))
            ...
            class S {
                ...
                static get singletonInstance() {
                    return S.databaseInstanceName || (S.databaseInstanceName = "ONE_SIGNAL_SDK_DB"),
                    S.databaseInstance || (S.databaseInstance = new S(S.databaseInstanceName)),
                    S.databaseInstance
                }
                ...
                getAppState() {
                    ...
                    n.mG)(this, void 0, void 0, (function*() {
                        ...
                        e.pendingNotificationClickEvents = yield this.getAllPendingNotificationClickEvents(),
                        e.lastKnownPushId = yield this.get("Options", "lastPushId"),
                        e.lastKnownPushToken = yield this.get("Options", "lastPushToken"),
                ...
                setAppState(e) {
                    ...
                    n.mG)(this, void 0, void 0, (function*() {
                        ...
                        null != e.lastKnownPushEnabled && (yield this.setIsPushEnabled(e.lastKnownPushEnabled)),
                        null != e.lastKnownPushId && (yield this.put("Options", {
                            key: "lastPushId",
                            value: e.lastKnownPushId
                        })),
                        null != e.lastKnownPushToken && (yield this.put("Options", {
                            key: "lastPushToken",
                            value: e.lastKnownPushToken
                        })),
                        null != e.lastKnownOptedIn && (yield this.put("Options", {
                            key: "lastOptedIn",
                ...
                getUserState() {
                    ...
                    n.mG)(this, void 0, void 0, (function*() {
                        const e = new c;
                        return e.previousOneSignalId = "",
                        e.previousExternalId = "",
                        e.previousOneSignalId = yield this.get("Options", "previousOneSignalId"),
                        e.previousExternalId = yield this.get("Options", "previousExternalId"),
                        e
                    }
                    ))
                }
                ...
                static rebuild() {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        return Promise.all([S.singletonInstance.remove("Ids"), S.singletonInstance.remove("NotificationOpened"), S.singletonInstance.remove("Options"), S.singletonInstance.remove(b), S.singletonInstance.remove(v), S.singletonInstance.remove("SentUniqueOutcome")])
                    }
                    ))
                }
                static on(...e) {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        return S.singletonInstance.emitter.on.apply(S.singletonInstance.emitter, e)
                    }
                    ))
                }
                ...
                static getLastNotificationClickedForOutcomes(e) {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        return yield S.singletonInstance.getLastNotificationClickedForOutcomes(e)
                    }
                    ))
                }
                ...
                static putNotificationReceivedForOutcomes(e, t) {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        return yield S.singletonInstance.putNotificationReceivedForOutcomes(e, t)
                    }
                    ))
                }
                ...
                static putNotificationClickedForOutcomes(e, t) {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        return yield S.singletonInstance.putNotificationClickedForOutcomes(e, t)
                    }
                    ))
                }
                static putNotificationClickedEventPendingUrlOpening(e) {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        return yield S.singletonInstance.putNotificationClickedEventPendingUrlOpening(e)
                    }
                    ))
                }
                ...
                static trigger(e, t, i) {
                    ...
                    n.mG)(this, void 0, void 0, (function*() {
                        if (!r.Z.contains(l, e)) {
                            ...
                            i || !1 === i ? a.Z.debug(`(${n}) » ${e}:`, i) : a.Z.debug(`(${n}) » ${e}`)
                        }
                        if (o.Z.isBrowser()) {
        ...
        271: (e, t, i) => {
            ...
            class d {
                ...
                static redetectBrowserUserAgent() {
                    return "" === (0,
                    l.M)().name && "" === (0,
                    l.M)().version ? o()._detect(navigator.userAgent) : o()
                }
        ...
        985: (e, t, i) => {
            ...
            class r {
                ...
                static privateTriggerNotificationPermissionChanged(e) {
                    return (0,
                    n.mG)(this, void 0, void 0, (function*() {
                        const t = yield OneSignal.context.permissionManager.getPermissionStatus()
                          , i = yield o.ZP.get("Options", "notificationPermission");
                        (t !== i || e) && (yield o.ZP.put("Options", {
                            key: "notificationPermission",
                            value: t
                        }),
                        s.Z.trigger(OneSignal.EVENTS.NOTIFICATION_PERMISSION_CHANGED_AS_STRING, t),
                ...
                static triggerBooleanPermissionChangeEvent(e, t, i) {
                    const n = "granted" === t;
                    (n !== ("granted" === e) || i) && s.Z.trigger(OneSignal.EVENTS.NOTIFICATION_PERMISSION_CHANGED_AS_BOOLEAN, n)
                }
            }
            r.executing = !1
        }
        ...
        353: (e, t, i) => {
            ...
            function E(e, t, i, n=!1) {
                if (t || a.Z.error("Cannot call on() with no event: ", t),
            ...
            function T(e) {
                return e ? "safari" == (0,
                l.M)().name && e.safari ? e.safari : "firefox" === (0,
                l.M)().name && e.firefox ? e.firefox : e.chrome || e.firefox || e.safari || "default-icon" : "default-icon"
            }
            function k(e) {
                const t = document.querySelector(e);
                return t || (a.Z.debug(`No instance of ${e} found. Returning stub.`),
    ...
    ( () => {
        ...
        !function() {
            ...
            (0,
            e.iJ)() > 1)
                return t.Z.warn("OneSignal: The web push SDK is included more than once. For optimal performance, please include our SDK only once on your page."),
                void t.Z.debug(`OneSignal: Exiting from SDK initialization to prevent double-initialization errors. Occurred ${(0,
                e.iJ)()} times.`);
